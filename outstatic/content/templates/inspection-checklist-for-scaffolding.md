...
**Q: How often must a scaffold be inspected?**
A: A formal, documented inspection by a Competent Person is required before each shift, after any alteration, and following any event (like severe weather) that could affect the structural integrity.

**Q: Can I modify the scaffold if I’m in a hurry?**
A: No. Any modification—including the removal of a single cross-brace or handrail—renders the scaffold unsafe. Work must cease, and the scaffold must be re-inspected and re-tagged by a Competent Person before use resumes.
