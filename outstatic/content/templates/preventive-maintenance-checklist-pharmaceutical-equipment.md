...
**1. How do I determine if a maintenance task requires a re-validation?**
Any maintenance that alters the physical dimensions, material composition, or software logic of the equipment typically requires a formal Change Control process and a risk-based assessment to determine if IQ/OQ/PQ is necessary.

**2. What should I do if I find a piece of equipment is damaged but the PM isn't due for three months?**
Any identified defect must be documented immediately. If the defect impacts product quality, safety, or data integrity, the equipment must be tagged "Out of Service" until a corrective maintenance action is completed.
