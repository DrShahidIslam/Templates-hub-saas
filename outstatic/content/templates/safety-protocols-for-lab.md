...
A: It is generally discouraged, as contacts can trap vapors or chemicals against the cornea in the event of a splash. If you must wear them, ensure you are wearing splash-proof goggles at all times.

**Q: Where can I find the Safety Data Sheets (SDS)?**
A: SDS binders are located on the main safety shelf near the laboratory entrance. Digital copies are also available on the laboratory server.
