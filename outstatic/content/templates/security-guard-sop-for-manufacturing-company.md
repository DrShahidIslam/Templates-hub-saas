...
**Q: Should I personally stop a shoplifter or internal thief?**
A: No. Your primary role is to observe, document, and report. Physical intervention should only occur if there is an imminent threat to human life or as a last resort in self-defense.

**Q: What is the procedure if a visitor refuses to show ID?**
A: Politely inform them that access is conditional upon identification. If they continue to refuse, deny entry and contact the site manager or the host of their meeting to resolve the issue.
