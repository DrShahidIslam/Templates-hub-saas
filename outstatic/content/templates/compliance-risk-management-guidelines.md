...
**1. How often should we conduct a compliance risk assessment?**
At a minimum, assessments should be performed annually. However, trigger events—such as entering a new market, launching a new product line, or significant legislative changes—necessitate an ad-hoc assessment.

**2. What should I do if a compliance breach occurs?**
Follow the established "Incident Response Plan." Immediately document the breach, assess the severity, contain the issue to prevent further exposure, and report it to the Legal/Compliance lead and relevant regulatory bodies as required by law.
