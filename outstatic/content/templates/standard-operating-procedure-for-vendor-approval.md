...
**Q: How often should we re-verify existing vendors?**
A: We recommend a comprehensive re-evaluation at least once per year for high-risk vendors and every two years for standard suppliers.

**Q: What should I do if a vendor refuses to share financial documentation?**
A: If a vendor is unwilling to provide transparency, assess the level of risk. If they are a sole-source provider, request a limited audit or third-party verification report in lieu of raw financial statements.
