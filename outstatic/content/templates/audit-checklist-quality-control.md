...
**Q: What is the difference between a Quality Audit and Quality Control?**
A: Quality Control is the process of checking products for defects (the "doing"), whereas a Quality Audit is the process of checking that the QC system itself is functioning as intended (the "verifying").

**Q: How do I handle staff resistance during an audit?**
A: Emphasize that the audit is a tool to protect them and the company from liability. Focus on "process improvement" rather than "performance evaluation."
