...
**Q: How do we handle salary negotiations?**
A: All negotiations should be handled by the HR/Recruitment lead based on internal equity, market benchmarks, and the candidate’s experience level. Hiring managers should avoid discussing specific compensation figures to remain focused on role fit.

**Q: What should we do if the interview panel disagrees on a candidate?**
A: Re-evaluate the candidate against the Scorecard. If the disagreement persists, involve a third-party leader or the department head to perform an additional interview to break the tie.
