...
**Q: What is the standard action if a drug reaches its expiration date while in stock?**
A: The drug must be immediately removed from the dispensing area, quarantined, labeled "EXPIRED: DO NOT DISPENSE," and processed for regulated disposal. It must never be returned to active inventory.

**Q: Can I donate near-expiry medication to a charitable clinic?**
A: Generally, no. Most jurisdictions have strict laws regarding the distribution of pharmaceuticals. Unless you have a pre-approved legal partnership and the medication remains well within the stability window, it is safer and more compliant to return it to the manufacturer or dispose of it through a licensed facility.
