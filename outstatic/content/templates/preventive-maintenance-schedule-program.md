...
**1. How do I handle emergency work that interferes with the PM schedule?**
Emergency repairs take precedence. However, when a PM is delayed due to an emergency, it must be automatically rescheduled within the CMMS for no later than 72 hours after the emergency is resolved.

**2. What should I do if a technician discovers a major issue during a routine PM?**
The technician should immediately "fail" the PM work order, move the asset to a red-tagged status, and open a secondary "Corrective Maintenance" work order to resolve the specific issue before returning the asset to service.
