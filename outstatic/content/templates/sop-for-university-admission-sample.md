...
Q: How should we handle applicants who request an extension on their document submission?
A: Extensions should be granted only in exceptional circumstances (e.g., natural disasters, major system failures) and must be approved in writing by the Admissions Director.

Q: What is the procedure if a duplicate application is detected?
A: Merge the records into the earliest created profile and notify the IT department to purge the secondary account to maintain data integrity.
