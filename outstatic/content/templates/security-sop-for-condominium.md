...
**Q: What should I do if a resident refuses to provide ID or sign in a guest?**
A: Politely explain that building security policy requires verification for the safety of all residents. If they refuse, contact the Property Manager on call for authorization. Do not get into a verbal altercation.

**Q: How do I handle a noise complaint from a resident?**
A: Record the complaint in the log. If the noise is ongoing, go to the unit in question, knock politely, and inform the resident of the complaint. If the noise continues after the warning, report it to management for future enforcement action.
