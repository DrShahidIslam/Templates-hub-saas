...
**1. What software should I use to create the flow?**
For simple flows, standard tools like Microsoft Visio, Lucidchart, or Miro are excellent. For collaborative projects, Miro or FigJam offer superior real-time editing capabilities.

**2. How do I know if my process flow is too detailed?**
If a process flow requires more than three levels of sub-processes or takes up more than two pages, you are likely focusing on task-level instructions rather than the high-level process. Break it into a "Summary Map" and separate "Standard Operating Procedures" for the specific tasks.
