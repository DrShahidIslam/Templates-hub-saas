...
**Q: How often should SOP compliance monitoring be performed?**
A: High-risk or safety-critical processes should be monitored monthly. Standard operational processes can be audited quarterly or biannually depending on the risk profile.

**Q: What is the difference between an audit and a monitoring activity?**
A: Monitoring is a continuous or frequent activity to ensure processes are running as expected, whereas an audit is a formal, retrospective review of those processes against a set of standards.
