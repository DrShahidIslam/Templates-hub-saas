...
**Q: What should I do if an invoice is missing a Purchase Order?**
A: Follow the "Non-PO Invoice" procedure. Flag the invoice for the relevant department head to provide a cost center code and written authorization for the expense before entering it into the system.

**Q: How do we handle discrepancies in price between the PO and the Invoice?**
A: You must contact the procurement team to verify if a price change was authorized. Do not pay the invoice until either a Change Order (CO) is processed or the vendor issues a credit note to match the PO price.
