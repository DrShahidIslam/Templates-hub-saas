...
A: Immediately alert all personnel in the vicinity. If the spill is minor and you are trained, use the spill kit. If the spill is large, toxic, or volatile, evacuate the room, pull the fire alarm, and contact the Safety Office/Emergency Services immediately.

**Q: How often should the eyewash and safety shower stations be tested?**
A: Eyewash stations must be flushed weekly to prevent microbial growth. Safety showers should be inspected and tested by facilities personnel at least annually.
