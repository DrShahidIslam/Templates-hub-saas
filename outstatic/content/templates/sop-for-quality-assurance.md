...
Quality Assurance is process-oriented (preventing defects), while Quality Control is product-oriented (identifying defects). This SOP covers both, focusing on process integrity to ensure product quality.

**2. How often should this SOP be reviewed?**
This SOP should be reviewed bi-annually or immediately following a "Critical" incident/non-conformance report to ensure the procedures remain relevant to current operational risks.
