...
**1. How often should we conduct cycle counts?**
For high-velocity items, perform counts weekly. For "C" items (slow movers), monthly or quarterly counts are generally sufficient to maintain accuracy.

**2. What should I do if my physical count consistently differs from my IMS records?**
This indicates a process failure. Investigate the receiving area, shipping documentation, and access controls. You may need to review staff training or restrict access to the IMS to prevent unauthorized manual adjustments.
