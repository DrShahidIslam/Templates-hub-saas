...
**Q: How often should environmental monitoring be performed in a non-sterile area?**
A: Frequency is determined by your facility’s risk assessment. Typically, high-traffic areas are monitored weekly or monthly, while low-risk storage areas may be monitored quarterly.

**Q: What should I do if a plate shows a "Too Numerous To Count" (TNTC) result?**
A: A TNTC result is an alert. Immediately inform QA, initiate an investigation to identify the root cause, and increase the frequency of monitoring in that specific zone until the bioburden is back under control.
