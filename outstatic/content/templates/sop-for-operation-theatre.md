...
**1. What should be done if a sterile field breach is suspected?**
Immediately notify the circulating nurse and the surgeon. Treat the affected area as contaminated, dispose of the compromised items, and re-establish the sterile field before proceeding. Never guess—if in doubt, it is contaminated.

**2. How often should the OT undergo terminal cleaning?**
Terminal cleaning must be performed at the end of each surgical list or at the end of every 24-hour cycle. If a septic or infectious case is handled, a specialized terminal cleaning protocol must be triggered immediately following the exit of the patient.
