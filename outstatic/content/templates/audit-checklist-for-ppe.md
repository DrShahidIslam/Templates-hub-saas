...
**Q: How often should a formal PPE audit be conducted?**
A: A comprehensive formal audit should be conducted quarterly at a minimum. However, high-risk environments or sites with high PPE turnover should shift to monthly audits.

**Q: What should I do if I find PPE that is slightly damaged but still "usable"?**
A: Never use damaged PPE. If in doubt, tag it as "Out of Service" and replace it. The cost of a new piece of equipment is negligible compared to the cost of an injury or a regulatory fine.
