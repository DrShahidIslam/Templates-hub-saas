...
A: Frequency is determined by the manufacturer's recommendations and the instrument’s intensity of use. Typically, high-use equipment requires quarterly or bi-annual PMs, while others may only require annual service.

**Q: Can I perform PMs myself, or do I need a technician?**
A: Routine maintenance (cleaning, filter changes, software updates) can be performed by trained lab staff. However, any repair involving proprietary internal electronics or specialized alignment should be handled by a certified manufacturer field service engineer (FSE) to maintain warranty compliance.
