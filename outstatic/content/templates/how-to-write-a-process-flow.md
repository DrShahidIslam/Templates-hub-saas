...
**Q: How do I know how much detail to include in a process flow?**
A: Use the "New Hire Test." If a reasonably skilled person can perform the task using your flow without asking more than one or two clarification questions, your level of detail is sufficient.

**Q: What is the difference between a process flow and an SOP?**
A: A process flow is a visual representation of the sequence of events. An SOP is the narrative documentation that provides the context, policies, and specific instructions for those steps. They should always be used together.
