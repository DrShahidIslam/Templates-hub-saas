...
**Q: How do we handle guests with unexpected dietary requirements?**
A: Always carry a "buffer" of 5% extra vegetarian and gluten-free meals. If a specific allergy is mentioned that was not pre-booked, consult the Lead Chef immediately—do not guess or provide a substitute without confirmation.
