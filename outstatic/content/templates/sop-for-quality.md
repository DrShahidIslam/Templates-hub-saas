...
**Q: What should I do if the equipment fails calibration during the shift?**
A: Stop all production immediately. Quarantine all products produced since the last verified calibration and escalate the issue to the Maintenance and Quality Managers for an impact assessment.

**Q: How do we handle minor defects that don't affect function but affect aesthetics?**
A: Refer to the "Visual Standard Guide." If the defect is within the "Acceptable Aesthetic Variance" threshold, it may proceed; if not, it must be diverted to rework.
