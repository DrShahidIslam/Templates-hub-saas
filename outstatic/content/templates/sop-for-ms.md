...
**Q: How often should the MS documentation be reviewed?**
A: Documentation should undergo a formal review at least annually, or immediately following any significant change in business operations, technology, or regulatory requirements.

**Q: Who is responsible for updating the MS if a process changes?**
A: The assigned Process Owner is responsible for drafting the change, but the Quality Manager or Compliance Officer must review and approve the update before it is published to the live system.
