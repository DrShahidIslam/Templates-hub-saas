...
**1. How do I know if a helmet is too old to use?**
Most manufacturers recommend replacing a helmet every 3 to 5 years, even if it hasn't been in a crash, because the plastic materials can degrade over time due to UV exposure and sweat.

**2. What should I do if my child’s chain keeps falling off?**
This usually indicates a "derailleur" issue or a loose chain. Check the tension screws on the derailleur and ensure the chain isn't stretched. If the problem persists, take it to a professional shop, as the drivetrain may require an adjustment or replacement.
