...
**Q: How do I know if the extinguisher is functional before an emergency?**
A: Check the pressure gauge monthly. The needle should be within the green zone. Ensure the pin is intact, the tamper seal is unbroken, and the service tag is current.

**Q: Can I use a Class A extinguisher on an electrical fire?**
A: No. Using an extinguisher not rated for Class C on electrical equipment can result in electrical shock. Only use extinguishers explicitly labeled for the type of fire you are facing.
