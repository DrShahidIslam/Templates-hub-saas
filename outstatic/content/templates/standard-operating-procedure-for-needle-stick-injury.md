...
**1. What if the source patient refuses testing?**
If the source patient refuses testing, treat the incident as "high-risk" by default. Occupational Health will base the prophylactic treatment strategy on the patient's clinical history and your own risk assessment.

**2. Does an NSI always require PEP?**
No. PEP is not required for all exposures. It is reserved for high-risk injuries involving known or suspected positive sources. Your Occupational Health physician will determine the necessity of PEP based on your specific case.
