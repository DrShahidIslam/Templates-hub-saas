...
**Q: What should I do if an employee refuses to provide a specimen?**
A: Treat a refusal to test as a positive result. Document the refusal clearly, have the collector and a witness sign the report, and notify HR immediately for disciplinary action consistent with company policy.

**Q: Who pays for the drug test?**
A: Unless prohibited by specific state law, the employer is generally responsible for all costs associated with pre-employment and employer-mandated testing.
