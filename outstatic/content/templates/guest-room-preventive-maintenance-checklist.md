...
**Q: How often should a full PM inspection be conducted per room?**
A: Industry standard is at least once per quarter (4 times per year). High-occupancy properties or older assets may require more frequent, condensed cycles.

**Q: What should I do if I find a major repair issue during a routine PM?**
A: If the issue requires significant time, parts, or creates a noise/safety disturbance for a guest, mark the room as "Out of Order" (OOO) in the Property Management System (PMS) and escalate to the Chief Engineer.
