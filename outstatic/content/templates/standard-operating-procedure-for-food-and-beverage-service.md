...
**1. What should I do if a guest has a severe food allergy?**
Immediately notify the kitchen and the manager on duty. Ensure the order is flagged in the POS system and the plate is delivered with a specific allergy protocol (e.g., using a different colored tray or a manager-led delivery).

**2. How do I handle a busy period when I am overwhelmed?**
Prioritize tasks by urgency: 1) Safety/Allergies, 2) Greeting guests, 3) Delivering food, 4) Clearing tables. Communicate with your teammates; teamwork is essential during high-volume service.
