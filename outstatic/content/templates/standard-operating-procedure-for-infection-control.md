...
**Q: If I am wearing gloves, do I still need to use hand sanitizer?**
A: Yes. Gloves may have micro-perforations invisible to the naked eye. Hand hygiene must be performed immediately after removing gloves to ensure no pathogens were transferred to the skin during use or removal.

**Q: How often should the cleaning log be updated?**
A: Every cleaning event must be logged immediately upon completion. If a surface is cleaned outside of the scheduled rotation due to a spill or heavy use, that must be recorded separately to maintain an audit trail.
