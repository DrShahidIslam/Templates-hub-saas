...
**1. What should I do if I discover a fault during the inspection?**
Immediately remove the key, attach a "Do Not Operate" tag to the steering wheel, and notify your supervisor or the maintenance manager. Do not attempt to operate the machine until it has been cleared by a qualified technician.

**2. How long should the inspection take?**
A thorough inspection typically takes between 5 to 10 minutes. Rushing the process increases the likelihood of missing a critical safety defect.
