...
**Q: Who is responsible for updating the Onboarding Tracker?**
A: The direct hiring manager is the primary owner of the tracker, though they may delegate specific administrative tasks to an HR Coordinator or Team Lead.

**Q: What should I do if a task in the tracker is delayed?**
A: Any delay that impacts the employee's ability to perform their job (e.g., access to a software license) must be escalated to the Department Head immediately to prevent productivity loss.
