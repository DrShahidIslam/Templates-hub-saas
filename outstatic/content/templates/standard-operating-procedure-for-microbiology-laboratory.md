...
**1. How often should the laboratory surfaces be disinfected?**
Surfaces must be disinfected at the start of every shift and immediately following any spill or completion of a specific task.

**2. What should I do if a biological spill occurs?**
Notify the laboratory supervisor immediately. Cover the spill with paper towels, saturate with a 10% bleach solution, and allow it to sit for at least 20 minutes before cleaning up with appropriate tools. Always wear double gloves during the cleanup.
