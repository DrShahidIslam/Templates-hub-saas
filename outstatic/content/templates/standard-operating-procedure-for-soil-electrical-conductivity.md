...
**1. Why is the 1:2 soil-to-water ratio used?**
The 1:2 ratio is chosen because it provides enough liquid to extract soluble salts while remaining simple to perform in a high-throughput environment. It provides a reliable index for salinity without the complexities of a Saturated Paste Extract (SPE), which is more time-consuming.

**2. How do I convert mS/cm to dS/m?**
The conversion is a 1:1 ratio. 1 mS/cm (milliSiemens per centimeter) is numerically equal to 1 dS/m (deciSiemens per meter). Most agricultural soil guidelines are expressed in dS/m.
