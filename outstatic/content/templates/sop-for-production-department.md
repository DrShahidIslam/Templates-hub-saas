...
**Q: What should I do if a machine shows an error code not listed in the manual?**
A: Do not attempt to bypass the error. Immediately place the machine in a "Lockout/Tagout" (LOTO) state and notify the Maintenance Department and your Shift Supervisor.

**Q: How do we handle raw material shortages mid-shift?**
A: Record the exact time of the stockout, notify the Inventory Coordinator, and pivot to secondary tasks (such as cleaning or equipment maintenance) to ensure no labor time is wasted.
