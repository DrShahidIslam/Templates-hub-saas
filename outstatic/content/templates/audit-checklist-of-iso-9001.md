...
A: ISO 9001 does not mandate a specific frequency, but standard practice dictates a full system audit at least once every 12 months. Many organizations choose to audit specific processes quarterly to maintain a state of "audit readiness."

**Q: What is the difference between a Correction and a Corrective Action?**
A: A Correction is an immediate fix (e.g., throwing away a defective part). A Corrective Action involves investigating the root cause of why that defective part was created and implementing a permanent change to the process to prevent recurrence.
