...
**Q: What should the student do if they fall behind on the daily schedule?**
A: Do not sacrifice the quality of deep work to "catch up." Identify the lowest-priority task for that day and move it to the Saturday "overflow" session or the following morning's review window.

**Q: How do we handle "motivation slumps" during the day?**
A: Audit the environment. Check for proper lighting, adequate room ventilation, and ensure the student has had sufficient movement/physical activity. Often, a lack of motivation is a physiological, not psychological, issue.
