...
**1. How do we handle a late arrival guest during the processional?**
Instruct ushers to hold late guests at the back until the bridal party has reached the front of the aisle. Use your discretion to seat them only if it causes zero disruption to the processional.

**2. What should be done if the wedding party is running late?**
Do not panic. Communicate the delay to the Officiant and the Musicians. Adjust the "Prelude" music duration as needed and, if necessary, quietly inform the VIP guests of a slight delay to keep them comfortable.
