...
## FAQ
**Q: How do I handle a disagreement with a subcontractor during an inspection?**
A: Refer strictly to the signed construction documents and the applicable building code. If ambiguity persists, require an RFI (Request for Information) to be sent to the structural engineer or architect for a formal ruling.

**Q: What should I do if I find a non-compliant element during an inspection?**
A: Document the issue with photos, mark the area with neon construction spray or flags, and issue a "Correction Notice" to the responsible contractor. Do not sign off on any phase until the defect is remediated and re-inspected.
