...
**Q: What should I do if the physical delivery does not match the quantity on the PO?**
A: Immediately document the discrepancy on the Bill of Lading, have the driver sign the exception, and notify the Procurement Department within one hour of receipt.

**Q: If a delivery arrives during a busy production period, can I skip the inspection and do it later?**
A: No. Under no circumstances should materials be accepted into inventory without an inspection. If resources are constrained, the material must be moved to a "Pending Inspection" quarantine area until staff is available.
