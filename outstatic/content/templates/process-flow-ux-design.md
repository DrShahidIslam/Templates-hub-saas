...
**1. How do I know when to stop researching and start designing?**
You are ready to move from research to design once you have identified a clear, repeating pattern of user needs and have enough data to support your primary user personas without significant ambiguity.

**2. What is the difference between a user flow and a wireframe?**
A user flow is a strategic map of the sequence of actions a user takes to reach a goal. A wireframe is a tactical visual representation of a single screen’s layout and content.
