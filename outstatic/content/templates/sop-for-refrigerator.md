...
**Q: How often should the condenser coils be cleaned?**
A: At minimum, once per month. If the unit is located in a high-dust environment or near a kitchen fry station, bi-weekly cleaning is strongly recommended to prevent overheating.

**Q: What should I do if the refrigerator temperature rises above 41°F?**
A: Immediately move perishable food to a backup unit. Check that the door is sealed and that the unit isn't overstocked. If the temperature does not drop within 60 minutes, contact a certified refrigeration technician.
