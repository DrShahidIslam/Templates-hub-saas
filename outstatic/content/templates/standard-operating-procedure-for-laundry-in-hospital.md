...
**Q: Can linens from COVID-19 or highly infectious wards be washed with standard patient linens?**
A: No. Any linen identified as highly infectious must be treated as biohazardous and processed separately using validated high-temperature cycles or validated chemical disinfectants.

**Q: How often should the laundry transport carts be cleaned?**
A: Transport carts must be wiped down with a hospital-grade disinfectant after every delivery cycle. A deep-cleaning schedule (using a cart-wash machine or high-pressure spray) should be implemented weekly.
