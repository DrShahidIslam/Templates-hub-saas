...
**1. How often should this checklist be completed?**
The checklist must be completed at the start of every 12-hour shift and following every use of the emergency equipment to ensure the kit is restocked immediately.

**2. What should I do if a medication is missing during the check?**
Do not wait until the next shift. Immediately contact the pharmacy or the central supply department to replace the item and note the discrepancy in the unit’s incident logbook.
