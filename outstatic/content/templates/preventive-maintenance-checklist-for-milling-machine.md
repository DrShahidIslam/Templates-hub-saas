...
A: Coolant life depends on usage and maintenance. With proper skimming of tramp oil and regular concentration monitoring, coolant can last 6–12 months. If the fluid emits a foul odor or causes skin irritation, it must be replaced immediately.

**Q: Can I use generic grease for the ball screws?**
A: No. Always refer to the machine manual. High-precision ball screws often require specific lithium-based or specialized synthetic greases; the wrong type can cause overheating or poor lubrication performance.
