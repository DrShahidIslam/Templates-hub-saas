...
**Q: How often should a comprehensive procurement audit be conducted?**
A: A high-level operational audit should be conducted quarterly, with a full-scale financial compliance audit performed annually by an internal or external auditor.

**Q: What should I do if I find a discrepancy in a high-value purchase?**
A: Immediately quarantine the transaction, document the discrepancy in an audit finding report, and escalate the issue to the CFO or Head of Internal Audit before contacting the vendor.
