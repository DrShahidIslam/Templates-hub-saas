...
**Q: How often should lead aprons be tested for damage?**
A: Lead aprons must be visually inspected before every shift and subjected to a formal fluoroscopic inspection or radiograph check at least once every 12 months to detect internal cracks.

**Q: What is the procedure if the "X-Ray in Use" light fails?**
A: If the warning light is non-functional, the room must be taken out of service immediately. Place a physical "OUT OF SERVICE" sign on the door and contact biomedical engineering for repair.
