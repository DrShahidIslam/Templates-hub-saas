...
**1. How often should a full property audit be conducted?**
A comprehensive operational audit should be performed at least quarterly, while departmental spot-checks should be conducted on a weekly or bi-weekly basis.

**2. What should I do if I find a critical safety violation during an audit?**
Stop the audit immediately. Address the hazard, initiate a temporary mitigation plan, and inform the General Manager or the Director of Engineering before proceeding with the rest of the inspection.
