...
A: SOPs should be reviewed quarterly to ensure they align with current merchandising, security, or technology updates.

**Q: What should I do if a team member is repeatedly failing to follow the SOP?**
A: Initiate the formal performance management process. Identify if the issue is a lack of training (re-train) or a lack of compliance (coaching/disciplinary action).
