...
**Q: How often should we review our process flow elements?**
A: Reviews should be conducted quarterly or immediately following any significant changes in software, personnel, or organizational structure.

**Q: What is the biggest indicator that a process flow needs to be re-engineered?**
A: If a specific "Decision" element results in a return-to-sender loop (rework) more than 15% of the time, the upstream elements are likely failing to provide necessary information.
