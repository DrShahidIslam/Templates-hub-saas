...
The Quality Manual should be reviewed at least annually or whenever a significant change occurs in the organizational structure, product line, or regulatory environment.

**2. What is the difference between a corrective action and a preventive action?**
A corrective action addresses the root cause of an existing non-conformity to prevent recurrence. A preventive action is taken to eliminate the cause of a potential non-conformity before it occurs.
