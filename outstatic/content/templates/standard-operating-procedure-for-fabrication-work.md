...
A: Precision equipment such as bandsaws, press brakes, and measurement tools should undergo calibration every 6 months, or immediately following any significant maintenance or accidental impact.

**Q: What should I do if the material delivered does not match the BOM?**
A: Stop work immediately. Do not attempt to substitute materials without written approval from the Lead Engineer or Project Manager, as this may compromise the structural integrity of the final product.
