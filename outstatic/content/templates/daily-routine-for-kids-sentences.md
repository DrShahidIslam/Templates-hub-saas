...
**Q: What should I do if the child refuses to follow the scheduled sentence?**
A: Remain neutral. Reiterate the sentence once, then utilize a "natural consequence" approach. For example, if they do not dress on time, they must wear what they have chosen immediately, or sacrifice leisure time later in the day.

**Q: Should I change the sentences as the child gets older?**
A: Absolutely. As the child matures, shift from imperative commands ("Do this") to collaborative planning ("What is the first thing we need to accomplish to be ready on time?").
