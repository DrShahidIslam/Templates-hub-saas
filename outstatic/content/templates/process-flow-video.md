...
**Q: How long should a process flow video be?**
A: Ideally, keep individual videos under 5 minutes. If a process takes longer, break it into a "series" of short, thematic modules.

**Q: Should I use a screen recorder or a physical camera?**
A: Use the tool that best represents the environment. If the process is software-based, use a screen recorder with an integrated mouse-click visualizer. If it is mechanical or physical, use a camera with a macro lens or a stable tripod-mounted overhead shot.
