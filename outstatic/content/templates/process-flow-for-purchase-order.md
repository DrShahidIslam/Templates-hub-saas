...
**Q: What should I do if a vendor changes the price after the PO is issued?**
A: Do not pay the invoice. You must issue a "PO Change Order" in the system to reflect the price difference, which must then be re-approved by the original authorizing manager.

**Q: Can I split a large purchase into two smaller POs to avoid the higher-level approval threshold?**
A: Absolutely not. This is known as "split ordering" and is a severe violation of procurement policy that will lead to disciplinary action.
