...
**Q: Why does the smear need to be heat-fixed?**
A: Heat fixation serves two purposes: it kills the bacteria to ensure operator safety and it coagulates proteins in the specimen, ensuring the smear adheres firmly to the slide during the intensive washing steps.

**Q: What should I do if the background appears red instead of blue?**
A: A red background indicates inadequate decolorization. You should re-decolorize the slide with acid-alcohol for a longer duration, rinse, and re-apply the counterstain.
