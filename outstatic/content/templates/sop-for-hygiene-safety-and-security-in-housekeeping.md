...
**Q: What should I do if I find an unattended bag of jewelry or cash in a room?**
A: Do not touch or move the items. Immediately notify your floor supervisor and have them accompany you to verify and log the items, or secure them per your specific property's "Valuables Found" policy.

**Q: How do I handle a chemical spill?**
A: Refer to the Material Safety Data Sheet (MSDS) binder located in the supply closet. Use the designated spill kit to contain the spill, ensure proper ventilation, and alert your supervisor immediately.
