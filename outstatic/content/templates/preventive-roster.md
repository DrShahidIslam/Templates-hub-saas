...
**1. How far in advance should the preventive roster be published?**
Industry best practice is to publish at least two weeks (14 days) in advance. This gives staff sufficient time to manage personal commitments, which directly correlates to fewer call-outs and higher engagement.

**2. What should I do if a conflict arises after the roster is published?**
Implement a formal "Shift Swap" policy where the responsibility for finding a replacement lies with the employee, subject to manager approval. This minimizes management intervention while maintaining operational coverage.
