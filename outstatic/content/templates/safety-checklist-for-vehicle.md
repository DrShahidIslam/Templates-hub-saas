...
A: If the defect is safety-critical (e.g., brake issues, broken headlights, low tire pressure), the vehicle must be grounded immediately and reported to your supervisor. Do not operate the vehicle until repairs are verified.

**Q: How often should the emergency equipment be checked?**
A: While the pre-trip inspection ensures the equipment is present, a formal audit of expiration dates on fire extinguishers and first aid kits should be documented on a monthly basis.
