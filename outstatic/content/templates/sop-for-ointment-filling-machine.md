...
**Q: What should I do if the ointment fill weight is consistently lower than the target?**
A: First, check the hopper level to ensure adequate suction pressure. If levels are adequate, inspect the dosing piston seals for wear and tear, as leakage behind the seal is the most common cause of under-filling.

**Q: How often should the filling nozzle be inspected for damage?**
A: The nozzle tip should be inspected at the start of every shift and after any machine jam. Any microscopic burrs or dents can cause the ointment to trail or drip, compromising the seal of the final product.
