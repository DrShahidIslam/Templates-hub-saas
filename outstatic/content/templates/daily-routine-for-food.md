...
**Q: What should I do if a refrigeration unit is reading 45°F?**
A: Immediately relocate all temperature-sensitive items to a backup unit and submit a maintenance request. Do not attempt to fix electrical components yourself.

**Q: How often must we change the sanitizer solution in the buckets?**
A: Sanitizer solution should be changed every four hours, or immediately if it becomes cloudy or if the ppm level drops below the effective range on your test strip.
