...
**1. How do I handle a guest complaint about food quality?**
Listen actively without interrupting, apologize sincerely, replace the item immediately (or remove it from the bill), and alert the manager on duty to ensure the issue is documented in the logbook.

**2. What should I do if a piece of equipment fails during service?**
Immediately isolate the affected equipment, inform the manager, and switch to an emergency backup process if possible. If the issue affects food safety (e.g., a broken cooler), notify the health department if necessary and follow the contingency plan outlined in your Safety Manual.
