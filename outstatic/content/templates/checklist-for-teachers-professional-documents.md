...
**Q: How often should I review my professional documents?**
A: We recommend a comprehensive review once per semester, with minor updates made immediately upon the completion of any professional development activity or evaluation cycle.

**Q: Where should sensitive behavioral records be stored?**
A: All records involving student discipline or sensitive communication must be stored within the district's secure Student Information System (SIS) or authorized encrypted databases, not on personal cloud drives or removable media.
