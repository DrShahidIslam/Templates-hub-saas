...
**Q: Can I use an SOP immediately after the manager approves it?**
A: No. An SOP is only effective once it has been officially released by the Document Control department and the relevant staff have completed the required training.

**Q: What should I do if I find an error in an active SOP?**
A: Immediately report the error to your supervisor and initiate a Document Change Request (DCR). Do not attempt to "pen-and-ink" changes directly onto a controlled document.
