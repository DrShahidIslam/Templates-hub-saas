...
**Q: How often should an NPD internal audit be performed?**
A: Ideally, audits should be milestone-based (conducted at the conclusion of each project gate) rather than time-based. However, if a project is long-term, a quarterly audit is recommended to ensure documentation hasn't drifted.

**Q: Who should be responsible for leading these audits?**
A: Audits should be led by an individual independent of the project team, typically from a Quality Assurance (QA) or internal Process Improvement department, to maintain impartiality.
