...
**Q: What is the most common reason for road work failure?**
A: Poor drainage. If water is allowed to pool at the subgrade level, it will soften the soil and lead to premature pavement failure, regardless of how well the asphalt was laid.

**Q: When should I issue a "Stop Work" order?**
A: Issue an immediate stop if safety violations place workers or the public in danger, if unauthorized materials are being used, or if weather conditions make it impossible to achieve required compaction/curing.
