...
**Q: What should I do if a prospect asks for a discount immediately?**
A: Do not offer a discount on the first mention. Pivot to value: "Before we discuss pricing, I want to ensure we’ve addressed the ROI of [specific feature]. Let’s look at the value impact first."

**Q: How many follow-ups should I attempt before moving a lead to 'Closed-Lost'?**
A: We recommend a sequence of 8–10 touchpoints over a 21-day period across multiple channels (phone, email, LinkedIn). If no response is received by day 22, move to a long-term nurture cadence.
