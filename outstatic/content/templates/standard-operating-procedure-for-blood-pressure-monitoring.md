...
**Q: Should I measure blood pressure on both arms?**
A: Yes, during an initial assessment or annual physical, measure both arms. If a consistent difference of >10 mmHg is found, use the arm with the higher reading for future measurements.

**Q: How long should I wait between repeat measurements?**
A: Always wait at least 60 to 90 seconds between measurements to allow the blood flow to normalize in the limb.
