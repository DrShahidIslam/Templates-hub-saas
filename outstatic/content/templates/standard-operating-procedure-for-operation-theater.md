...
**Q: What should be done if the sterile field is accidentally compromised?**
A: Immediately alert the surgical team. Do not attempt to "fix" the area. Any item touched by non-sterile personnel or dropped below table level must be discarded, and the affected area must be re-draped or re-scrubbed by the surgeon.

**Q: How often should the OT environment be deep-cleaned?**
A: Beyond the standard between-case cleaning, the OT should undergo a terminal clean every 24 hours. This involves a comprehensive disinfection of all surfaces, lights, air vents, and floors.
