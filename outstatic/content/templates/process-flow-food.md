...
**Q: What should I do if a refrigeration unit exceeds the safe temperature range?**
A: Immediately relocate all temperature-sensitive items to a backup unit, alert the Maintenance Manager, and discard any products that have been in the "Danger Zone" for more than two hours.

**Q: Are gloves a substitute for handwashing?**
A: Absolutely not. Gloves are a secondary barrier. Handwashing must occur before donning new gloves, after touching raw food, after using the restroom, and after handling non-food items like trash or cleaning supplies.
