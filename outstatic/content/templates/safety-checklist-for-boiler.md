...
**Q: How often should a full safety checklist be completed?**
A: At a minimum, a formal safety checklist must be completed at the start of every shift (every 8 to 12 hours).

**Q: What should I do if the water level in the gauge glass is not visible?**
A: Immediately initiate an emergency shutdown. If the boiler is firing and the water level is below the bottom of the glass, the boiler is at risk of "dry firing," which can cause structural failure.
