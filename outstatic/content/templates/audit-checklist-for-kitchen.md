...
**Q: How often should a full kitchen audit be performed?**
A: A full audit should be conducted at least weekly. However, a "Daily Opening/Closing Checklist" should be completed every single shift to maintain standards between weekly audits.

**Q: What is the immediate procedure if a food safety violation is found?**
A: Immediately address the issue (e.g., discard food, repair equipment, or restock supplies). If the issue is a systemic failure, update the SOP and conduct a mandatory staff training session before the next shift.
