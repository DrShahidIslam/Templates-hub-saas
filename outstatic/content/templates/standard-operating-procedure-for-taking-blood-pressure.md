...
**1. Does it matter which arm I use?**
For the initial assessment, measure both arms. If there is a consistent difference of more than 10 mmHg, use the arm with the higher reading for all subsequent measurements.

**2. Should I round the numbers?**
Always round to the nearest 2 mmHg. Never guess or record values in odd numbers (e.g., 121/81), as this suggests an imprecise measurement.
