...
**1. What is the immediate protocol if a safety guard is missing from a machine?**
Immediately tag the machine as "Out of Service," notify your floor supervisor, and do not attempt to operate the machinery until the guard is replaced and inspected.

**2. How often should we conduct internal safety audits?**
While daily checklists are mandatory, a comprehensive "Deep-Dive" safety audit should be conducted by the Safety Committee on a monthly basis.
