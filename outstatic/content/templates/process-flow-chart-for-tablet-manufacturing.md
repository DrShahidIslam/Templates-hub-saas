...
## FAQ
**Q: What should be done if the LOD (Loss on Drying) is below the target range?**
A: If the moisture content is too low, the granules may become overly brittle, leading to excessive "fines" and potential capping during the compression stage. Stop the process and contact the formulation department for evaluation.

**Q: How often must equipment be calibrated?**
A: All critical instrumentation (scales, pressure gauges, temperature sensors) must be calibrated according to the established preventive maintenance schedule, usually annually or whenever the equipment is moved or repaired.
