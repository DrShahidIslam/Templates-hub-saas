...
**Q: How often should I review my PM checklists for accuracy?**
A: PM checklists should be reviewed annually or whenever a significant modification is made to the equipment. If the equipment frequently fails between inspections, the PM frequency or the scope of the checklist tasks should be re-evaluated.

**Q: What is the difference between a PM and a Work Order?**
A: A PM is a recurring, scheduled activity intended to prevent failure. A Work Order is typically an ad-hoc, reactive request for repair. A well-executed PM program should result in a decrease in corrective Work Orders.
