...
A: Frequency depends on the risk profile of the process. Generally, high-risk financial processes are audited annually, while low-risk operational areas may be audited every 2–3 years.

**Q: What should an auditor do if they encounter resistance from department management?**
A: Attempt to resolve the issue by demonstrating the value of the audit (e.g., how it protects the department from future regulatory penalties). If resistance continues, escalate to the Audit Committee or the internal audit lead to reiterate the audit’s mandate.
