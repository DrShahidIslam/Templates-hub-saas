...
**Q: What should I do if a prospect goes silent after the proposal is sent?**
A: Follow the "3-Touch Rule." Reach out via email, phone, and LinkedIn. If there is no response after the third attempt over a two-week period, set the status to "Nurture" and schedule a check-in for 30 days later.

**Q: Can I deviate from the standard contract pricing?**
A: All deviations from standard pricing require a written "Discount Approval" from the Sales Manager or Finance department, depending on the percentage of the discount.
