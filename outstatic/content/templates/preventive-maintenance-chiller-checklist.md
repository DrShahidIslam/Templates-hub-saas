...
A: Typically, a comprehensive inspection should be performed at least twice a year (before the cooling season and after). However, chillers in high-load or harsh environments should follow a quarterly schedule.

**Q: Why is my chiller showing a "High Head Pressure" alarm?**
A: This is most commonly caused by a fouled condenser coil, non-condensables (air) in the system, or insufficient condenser water flow due to a clogged strainer or failing pump.
