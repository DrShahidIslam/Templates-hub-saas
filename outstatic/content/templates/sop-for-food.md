...
**Q: What should I do if a piece of equipment malfunctions during service?**
A: Immediately stop using the unit, notify the Operations Manager, and move all temperature-sensitive items to a backup refrigerated unit. Do not attempt to repair the equipment while food is present.

**Q: Can I use the same cutting board for vegetables after using it for raw chicken if I rinse it with water?**
A: No. Rinsing with water is insufficient to remove pathogens. The board must be cleaned with soap, rinsed, and sanitized using a chemical disinfectant before being used for a different food category.
