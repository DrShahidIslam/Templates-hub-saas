...
**Q: What if I am too depressed to even look at this checklist?**
A: Lower the barrier to entry. Your only requirement is to read the first bullet point of the "Morning Activation" section. If you can do one thing, the day is a success.

**Q: Should I change the checklist if my depression fluctuates?**
A: Yes. Maintain two versions: a "Baseline" version for stable days and a "Survival" version that contains only 3–4 non-negotiable tasks for high-symptom days.
