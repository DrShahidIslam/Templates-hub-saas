...
**1. What should I do if a refrigerator temperature reading is above 40°F?**
Immediately notify the manager on duty. Attempt to identify the cause (e.g., door left ajar). If the temperature cannot be brought down within two hours, all perishable food in that unit must be discarded or moved to a functional backup unit.

**2. Can I use a sanitizing wipe for food preparation surfaces?**
No. Sanitizing wipes are generally for non-food contact surfaces. Food contact surfaces must be sanitized using a food-grade solution (such as a diluted bleach or quaternary ammonium solution) and left to air dry to ensure the required dwell time.
