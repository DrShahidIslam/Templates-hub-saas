...
**Q: How do we handle vendors who do not meet their SLA targets?**
A: Initiate a formal "Notice to Cure." Document the deficiencies, hold a meeting to discuss root causes, and implement a 30-day performance improvement period before considering contract termination.

**Q: What is the benefit of a centralized vendor database?**
A: It provides visibility into total organizational spend, helps identify opportunities for volume-based discounts, and ensures that compliance documents are easily retrievable during external audits.
