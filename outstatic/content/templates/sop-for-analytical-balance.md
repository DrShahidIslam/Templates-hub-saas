...
**Q: Why does the balance reading keep changing/drifting?**
A: Drifting is usually caused by air currents (drafts), temperature fluctuations (holding the vessel with warm hands), or moisture loss/absorption from the sample. Ensure the draft shield is closed and the sample is at room temperature.

**Q: How often should I calibrate the analytical balance?**
A: A daily "internal" calibration check is standard practice. A full "external" calibration using certified calibration weights should be performed at least annually or following any significant relocation of the instrument.
