...
**1. How long should we retain completed PM log sheets?**
Regulatory requirements vary, but it is industry best practice to retain logs for the entire lifecycle of the asset plus three years to ensure long-term historical analysis.

**2. What should I do if the equipment fails during a PM inspection?**
Immediately cease the PM, mark the equipment as "Out of Service" or "Tag Out," and initiate a Corrective Maintenance (CM) Work Order. The failure must be documented in the "Action Taken" section of the PM log.
