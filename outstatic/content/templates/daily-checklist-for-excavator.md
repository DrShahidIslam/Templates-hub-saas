...
A: Do not operate the machine. Tag the excavator as "Out of Service," notify your site supervisor immediately, and submit a maintenance work order. Never use your hands to check for leaks; use a piece of cardboard to avoid high-pressure injection injuries.

**Q: Is it necessary to grease the machine every single day?**
A: Yes. Grease is the cheapest maintenance insurance you have. Daily lubrication flushes out contaminants and prevents metal-on-metal wear in the high-stress pivot pins and bushings.
