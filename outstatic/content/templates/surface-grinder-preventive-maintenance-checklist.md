...
A: Dressing frequency depends on the material hardness and the required finish. Generally, dress the wheel whenever the cutting action becomes sluggish, the surface finish degrades, or you notice "loading" (metal particles embedded in the wheel).

**Q: Why does my machine table movement feel jerky?**
A: Jerky movement is usually caused by low way oil, clogged oil lines, or contaminated ways. Check your lubrication system immediately, as friction can cause permanent damage to the precision ground surfaces of the ways.
