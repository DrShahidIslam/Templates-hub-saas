...
**1. How do I know if the newborn is getting enough to eat?**
The most reliable indicators are consistent weight gain, a minimum of 6 heavy wet diapers per day, and a satisfied demeanor immediately following a feeding session.

**2. What are the warning signs that require immediate pediatric intervention?**
Seek medical attention if the infant has a fever (rectal temperature of 100.4°F/38°C or higher), persistent vomiting, lethargy, or signs of respiratory distress (flaring nostrils or rapid, shallow breathing).
