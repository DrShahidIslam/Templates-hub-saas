...
**Q: How often should a comprehensive lighting inspection be performed?**
A: A visual walk-through for outages should be performed weekly. A comprehensive technical inspection, including emergency battery testing and lux level verification, should be conducted at least quarterly.

**Q: What should I do if a motion sensor is staying on indefinitely?**
A: First, clean the sensor lens to remove dust or cobwebs. If the issue persists, check the "time-delay" and "sensitivity" settings; they may be set too high, causing the unit to react to HVAC airflow or minor vibrations.
