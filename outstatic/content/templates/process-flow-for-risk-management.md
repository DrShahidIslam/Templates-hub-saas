...
A: A risk is an uncertain event that *may* occur in the future; an issue is an event that has already occurred and is currently impacting operations.

**Q: How often should we update the Risk Register?**
A: While it should be monitored continuously, the register should undergo a formal, comprehensive review at least once per quarter, or immediately following any significant organizational change.
