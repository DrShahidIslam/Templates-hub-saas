...
A: Ideally, calibrate before every set of measurements. At minimum, perform a 2-point calibration at the start of each work shift to account for sensor drift.

**Q: Why does my reading keep drifting?**
A: Drifting is usually caused by a dirty electrode, a clogged reference junction, or insufficient stabilization time. Check the electrode cleanliness and ensure the sample is at a stable temperature.
