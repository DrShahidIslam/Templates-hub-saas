...
**1. What is the maximum timeframe allowed to submit an initial NCRP-CFCFRMS report?**
Initial reports must be submitted into the system within 30 minutes of identifying the non-conformance. If field conditions prevent this, notify the shift lead immediately to ensure interim documentation is started.

**2. Who is authorized to override a "Critical" status categorization?**
Only the Quality Assurance Manager or the Operations Director may downgrade a "Critical" status after a comprehensive safety and impact assessment has been performed.
