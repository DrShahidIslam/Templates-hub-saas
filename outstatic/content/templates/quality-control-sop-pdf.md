...
**Q: What should I do if a PDF file is too large due to high-resolution images?**
A: Use a professional-grade PDF compressor or downsample images to 150 DPI during the export process. Do not sacrifice readability for file size; ensure all text and critical defect details remain clear.

**Q: Can I edit a QC PDF after it has been uploaded?**
A: No. Once a QC report is finalized and uploaded, it is considered a legal record. If an error is discovered, you must upload a new version with an incremented revision number and append a "Correction Memo" to the file.
