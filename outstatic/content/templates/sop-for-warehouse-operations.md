...
**Q: How often should we conduct a full facility wall-to-wall inventory count?**
A: While cycle counting is preferred for ongoing accuracy, a full wall-to-wall audit should be performed at least once per fiscal year to reconcile accounting discrepancies.

**Q: What is the procedure if a discrepancy is found during a cycle count?**
A: If a discrepancy exceeds the allowable variance threshold, the inventory must be frozen, an investigation of the transaction history for that SKU must be conducted, and a manager must approve the final adjustment.
