...
**1. How should I handle extracurricular activities that overlap with the homework block?**
Prioritize the "Fixed vs. Flexible" rule. If an activity is fixed (e.g., sports practice), shift the homework block to immediately before the activity or split it into two 45-minute sessions.

**2. What if my child feels "burned out" by this rigid structure?**
View the routine as a framework rather than a cage. If the child is consistently performing well, grant "schedule flexibility" on Friday evenings as a reward, allowing them to manage their own time while still adhering to the core sleep hygiene rules.
