...
## QC Department Step-by-Step Checklist
...
**1. What should I do if a shipment is urgent but testing is not yet complete?**
Under no circumstances may you bypass testing for urgency. You must escalate the issue to the Quality Manager. If a temporary release is required, it must be documented via a "Concession/Deviation Request" signed by authorized management.

**2. How often should QC testing equipment be calibrated?**
All testing equipment must be calibrated according to the manufacturer’s schedule or annually, whichever is more frequent. Calibration status stickers must be visible on every device at all times.
