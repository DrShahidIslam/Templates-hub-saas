...
**Q: What should I do if I find a stray component from the previous batch after the clearance has already been signed off?**
A: Stop the line immediately. Do not attempt to dispose of it yourself. Notify Quality Assurance, document the event as a deviation, and perform a re-clearance of the entire area.

**Q: Does every line clearance require a Quality Assurance (QA) signature?**
A: Depending on the regulatory environment (e.g., FDA/EMA), yes. Most GMP environments require a secondary, independent verification by QA to ensure that the clearance was performed objectively and correctly.
