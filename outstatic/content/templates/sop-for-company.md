...
**Q: How often should our SOPs be audited?**
A: All SOPs should be reviewed at least annually. High-impact processes or those involving frequently updated software should be reviewed on a quarterly basis.

**Q: What do I do if I find a discrepancy between the written SOP and the actual task?**
A: Do not follow the incorrect SOP. Report the discrepancy to the Process Owner immediately and document the "Work-as-Performed" so the SOP can be updated to reflect reality.
