...
A: Standard industry practice suggests a comprehensive visual inspection annually and detailed electrical testing (leakage/grounding) every 2–3 years, or following any major lightning event in the vicinity.

**Q: What is the most common cause of arrester failure?**
A: Contamination of the external housing. Dust, dirt, and chemical buildup create a conductive path that leads to leakage current, localized heating, and eventual tracking failure.
