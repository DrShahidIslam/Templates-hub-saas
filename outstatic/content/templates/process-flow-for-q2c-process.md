...
**Q: How do we handle mid-contract changes?**
A: Changes should be handled via a formal "Change Order" process linked to the original contract ID in the CLM system to maintain audit integrity.

**Q: At what point is an opportunity officially "Closed-Won"?**
A: An opportunity is closed-won only after a countersigned contract is uploaded and the initial credit verification is cleared by Finance.
