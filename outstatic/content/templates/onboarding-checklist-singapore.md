...
**1. Is it mandatory to provide an Employment Contract in writing?**
Yes. Under the Employment Act, employers must provide employees with Key Employment Terms (KETs) in writing for all employees covered under the Act.

**2. What should I do if an employee does not have a CPF account?**
If a Singapore Citizen or PR is starting their first job, you must register them as an employer through the CPF portal. They will be automatically issued an account upon your first contribution.
