...
**Q1: What should I do if an analytical result is borderline?**
A: Do not report it as a "pass" without investigation. Perform a thorough review of the analytical process, check system suitability, and ensure no human error occurred. If in doubt, follow the formal OOS (Out-of-Specification) investigation SOP.

**Q2: How often should equipment be calibrated?**
A: Calibration frequency is defined by the instrument’s criticality and the manufacturer’s recommendations, typically established during the validation phase (IQ/OQ/PQ). Any deviation from the schedule must be justified and documented.
