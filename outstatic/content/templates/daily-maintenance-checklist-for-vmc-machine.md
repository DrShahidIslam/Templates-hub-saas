...
**Q: Why is my coolant concentration changing daily?**
A: This is usually due to evaporation or "tramp oil" contamination. Check for hydraulic leaks dripping into the coolant tank and ensure the machine is covered during downtime to minimize evaporation.

**Q: How often should I drain the air moisture trap?**
A: In high-humidity environments, this should be checked at the start of every shift. Moisture in the pneumatic lines can cause rust in the solenoid valves and cylinders, leading to intermittent tool changer failures.
