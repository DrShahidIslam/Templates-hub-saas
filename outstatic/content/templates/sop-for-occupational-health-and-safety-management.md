...
**1. How often should our OHS management system be audited?**
At minimum, a comprehensive internal audit should be performed annually. Third-party audits are recommended every two to three years to ensure objectivity and alignment with international standards like ISO 45001.

**2. What is the difference between a near-miss and an incident?**
An incident results in harm or damage; a near-miss is an unplanned event that did not result in injury or damage but had the *potential* to do so. Both must be reported, as near-misses are critical indicators of hidden hazards.
