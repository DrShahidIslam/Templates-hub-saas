...
A: SOPs should be reviewed at least annually, or immediately following any significant change in equipment, software, or regulatory requirements.

**Q: What should I do if a team member refuses to follow an SOP?**
A: Investigate the root cause. Often, non-compliance occurs because the SOP is inefficient or outdated. If the SOP is correct, address it through standard performance management and retraining.
