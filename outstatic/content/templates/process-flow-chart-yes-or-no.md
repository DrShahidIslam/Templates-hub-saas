...
**Q: What do I do if a process requires a "Maybe" or "Partial"?**
A: A "Maybe" is usually a sign of missing information. Add a "Data Gathering" or "Verification" task node immediately before the decision point to collect the missing info required to force a Yes/No conclusion.

**Q: Should I include automated system decisions in the same chart as manual human decisions?**
A: Yes. Including both provides a complete view of the operational lifecycle. Distinguish them visually by using different line styles (e.g., solid lines for human tasks, dashed lines for system automations).
