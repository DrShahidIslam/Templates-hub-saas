...
**1. Should security staff be allowed to handle cash or parcels for residents?**
No. Security personnel should not accept money or personal packages. This prevents allegations of theft or mishandling and keeps the focus strictly on safety.

**2. What should be done if a resident refuses to provide visitor details?**
Security must politely explain that the protocol is for the safety of the entire community. If the resident persists, escalate the matter immediately to the Security Supervisor or the Management Committee representative on duty.
