...
**Q: Can I lend my key to a coworker if they forgot theirs?**
A: No. Transferring keys between employees is strictly prohibited. If a colleague is locked out, they must report to the Security Desk to verify their credentials and request temporary access.

**Q: What happens if I find an unidentified key in the building?**
A: Do not attempt to test the key. Turn it in immediately to the Security Department so it can be cross-referenced against the Master Key Log to identify its origin.
