...
**Q: What should I do if a shipment arrives damaged?**
A: Take photos of the damage, note the condition on the delivery receipt (or refuse the shipment if severe), and notify your supervisor and the Procurement Department immediately.

**Q: How do I handle inventory discrepancies between my system and the actual count?**
A: First, verify all recent transaction logs for data entry errors. If no error is found, perform a recount. If the discrepancy persists, file an Inventory Adjustment Report for management approval.
