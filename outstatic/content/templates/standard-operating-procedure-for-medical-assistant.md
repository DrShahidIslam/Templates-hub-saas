...
**Q: What should I do if I notice a discrepancy in the patient’s medication list?**
A: Do not assume the EHR is correct. Ask the patient directly what they are taking at home, compare it to the current list, document the discrepancy, and flag the chart for the provider’s review before the encounter begins.

**Q: How should I handle a patient who is visibly distressed or angry?**
A: Remain calm and maintain a neutral, professional tone. Use active listening to identify the root cause of the frustration, apologize for the inconvenience without admitting clinical negligence, and alert the Practice Manager if the situation escalates.
