...
**Q1: How do I know which validation parameters I must test?**
A: Refer to the ICH Q2(R1) guidelines. The required parameters depend on the type of analytical method (e.g., Assay, Impurities, or Identification). If your method is a minor modification of an existing validated method, a "Verification" study may suffice instead of a full validation.

**Q2: What should I do if my method fails to meet acceptance criteria mid-study?**
A: Stop the study immediately and initiate a formal Laboratory Investigation. Do not manipulate the data. Determine the root cause (e.g., instrument drift, operator error, or method design) and decide whether to modify the method and restart the validation or document the failure and close the study.
