...
**What is the most critical item on this list?**
Food temperature logs are the most critical, as they are a legal requirement for health department compliance and are your primary defense against foodborne illness.

**What should I do if a team member misses a task on the checklist?**
Address it immediately during the shift. If it is a repeated issue, utilize the checklist as a documented record for performance coaching during one-on-ones.
