...
**Q: What should I do if the POS system crashes during a busy period?**
A: Immediately switch to the offline transaction log (if applicable) or a manual credit card imprint machine. Notify the Store Manager and IT support desk via the emergency escalation line.

**Q: How often should we conduct full store inventory audits?**
A: While daily cycle counts should occur on specific categories, a full physical store inventory audit is mandatory every 90 days to ensure operational integrity.
