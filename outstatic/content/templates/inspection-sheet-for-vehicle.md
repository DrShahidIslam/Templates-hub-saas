...
A: Immediately report the defect to the fleet manager or your supervisor. Do not operate the vehicle if the defect pertains to brakes, steering, tires, or lighting. Complete an "Out of Service" tag for the vehicle and document the issue in the digital log.

**Q: How often should I check the tire pressure?**
A: Ideally, tire pressure should be checked before every shift. At a minimum, pressure should be checked weekly, as fluctuating temperatures can cause significant PSI drops.
