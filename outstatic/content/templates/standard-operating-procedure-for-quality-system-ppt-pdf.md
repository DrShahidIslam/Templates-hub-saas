...
**Q: Why must I save the presentation as a PDF/A?**
A: PDF/A is the ISO-standardized version of PDF specifically designed for the long-term archiving of electronic documents, ensuring the file remains readable for years regardless of software updates.

**Q: How do I handle minor edits after a document has been released?**
A: Any change to a controlled document requires a formal revision process. Update the version number (e.g., v1.0 to v1.1), document the change in the Revision History log, and re-publish to the DCS.
