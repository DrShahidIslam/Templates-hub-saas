...
A: Thermometers should be calibrated at the start of every shift and whenever they have been dropped or exposed to extreme temperature changes.

**Q: What do I do if a refrigeration unit is found above 41°F?**
A: Notify the manager immediately. Move all perishable food to a backup cooler or ice bath and record the temperature and time. Do not attempt to "re-cool" the unit while food is inside.
