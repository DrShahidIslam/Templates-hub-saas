...
**Q: What should I do if I find a safety-critical issue during the inspection?**
A: Immediately shut down the crane, remove the keys, and apply a "Do Not Operate" tag. Notify your site supervisor and the maintenance department in writing. Do not energize the machine until it has been inspected and cleared by a certified technician.

**Q: Does a "Pre-Shift" inspection replace the annual crane inspection?**
A: No. Daily inspections are for the operator to ensure the machine is safe for the day's tasks. Annual inspections are exhaustive, require disassembly/non-destructive testing (NDT), and must be performed by a third-party certified inspector.
