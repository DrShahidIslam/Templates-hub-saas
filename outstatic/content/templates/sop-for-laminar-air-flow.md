...
**Q: How often should the pressure gauge be checked?**
A: The pressure gauge must be checked and recorded at the beginning of every shift or prior to every distinct procedure to ensure the filter is not clogged.

**Q: Can I use a Bunsen burner inside the LAF?**
A: No. Open flames create excessive heat and air turbulence, which disrupts the laminar flow patterns and can potentially melt the filter media or damage the blower motor. Use an electric incinerator if sterilization is required.
