...
**Q: What should I do if a guest has an allergic reaction?**
A: Follow the Emergency Action Plan immediately: alert the manager on duty, call emergency services if symptoms are severe, and preserve the meal sample for analysis.

**Q: How do we handle a high volume of complaints regarding ticket times?**
A: Assess if the bottleneck is in the kitchen or the FOH. If kitchen-based, the Expo must prioritize tables, and management should communicate transparently with guests to manage expectations.
