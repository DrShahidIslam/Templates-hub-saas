...
**Q: What is the procedure if a stock item is found damaged during a cycle count?**
A: Immediately segregate the item into the designated "Quarantine Area," document the damage with photographic evidence, and initiate an Inventory Adjustment Request to remove the item from the active ledger.

**Q: How often should the inventory software be reconciled with physical stock?**
A: While full counts occur annually, rolling cycle counts should happen daily to ensure continuous accuracy throughout the year.
