...
## FAQ
**Q: What should I do if the patient develops a fever during the transfusion?**
A: Stop the transfusion immediately, keep the vein open with normal saline, notify the provider and blood bank, and follow institutional protocol for suspected transfusion reactions (which usually involves sending the blood bag and a fresh blood sample back to the lab).

**Q: Can I hang blood at the same time as a saline drip?**
A: Yes, but they must be connected via a Y-site connector at the bottom of the infusion set. No other medications or fluids should be piggybacked into the blood line.
