...
While the administrative onboarding is completed in week one, the full cultural and operational integration usually takes 90 days. We structure the plan to transition from active onboarding to standard performance management by the end of the first quarter.

**2. What should I do if the new hire isn't getting access to their accounts on Day 1?**
IT provisioning should be handled two weeks in advance. If access is missing on Day 1, immediately escalate to the IT support lead and provide the new hire with non-sensitive documentation or reading materials so they are not left idle.
