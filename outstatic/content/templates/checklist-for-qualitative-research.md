...
**Q: How many participants are needed for a qualitative study?**
A: Unlike quantitative research, there is no set number for statistical significance. Generally, saturation is achieved between 8–12 participants for a homogenous segment; if you stop hearing new information, you have reached saturation.

**Q: How do I handle participants who provide irrelevant or "fluffy" answers?**
A: Use "funneling" techniques: start with a broad question, then use specific probing questions ("Can you give me an example of that?" or "What was the result of that situation?") to anchor them back to concrete experiences.
