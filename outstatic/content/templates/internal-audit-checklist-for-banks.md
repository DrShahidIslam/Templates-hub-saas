...
High-risk areas (like Treasury and IT Security) should be audited quarterly, while lower-risk administrative processes may only require annual reviews. A risk-based audit plan should be updated annually.

**2. What is the auditor’s responsibility regarding fraud detection?**
While the primary responsibility for preventing fraud lies with management and internal controls, the auditor is responsible for identifying weaknesses in those controls that could permit fraud to occur undetected.
