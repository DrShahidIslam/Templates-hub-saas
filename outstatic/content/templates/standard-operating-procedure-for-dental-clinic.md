...
A: Immediately stop using the autoclave. Place an "Out of Order" sign on the unit, quarantine all instruments sterilized since the last successful test, and contact the maintenance technician for an inspection.

**Q: How often should we flush the dental unit water lines?**
A: Water lines must be flushed for at least 30 seconds after every patient and for two minutes at the beginning and end of every workday to minimize microbial buildup.
