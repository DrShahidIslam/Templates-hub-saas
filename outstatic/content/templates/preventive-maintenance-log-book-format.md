...
**1. How long must we retain physical PM log books?**
Retention periods are governed by company policy and local regulations, but a standard industry best practice is to retain logs for the entire life of the asset plus three years.

**2. Should I include "Corrective Maintenance" in the PM log book?**
Yes. Consolidating all interventions into one chronological log provides a "cradle-to-grave" history of the asset, which is vital for identifying recurring failure patterns.
