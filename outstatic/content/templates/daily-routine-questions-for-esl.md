...
**Q: How do I handle a student who claims their routine is "boring"?**
A: Use this as an opportunity to introduce the concept of "ideal" routines. Ask, "If you could change one part of your daily routine to make it more productive, what would it be?" This shifts the conversation to the conditional tense.

**Q: Should I use a template or keep it conversational?**
A: Use a template for the first 10 minutes to establish structure, then transition to a free-flowing conversation for the remaining time to practice natural spontaneity.
