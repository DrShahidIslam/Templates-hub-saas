...
**Q: What should I do if I find a cylinder that has exceeded its hydrostatic test date?**
A: Immediately remove the cylinder from service, clearly mark it as "Expired/Do Not Use," and contact your medical gas supplier for a scheduled exchange. Do not attempt to use or store it with active equipment.

**Q: Can I use Teflon tape on the regulator connection to stop a leak?**
A: No. Under no circumstances should you apply Teflon tape or any sealant to the threads of an oxygen valve or regulator connection. These connections are designed to be metal-to-metal or utilize an O-ring; if it leaks, the connection is damaged and requires professional inspection.
