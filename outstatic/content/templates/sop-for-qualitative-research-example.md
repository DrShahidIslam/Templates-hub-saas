...
Unlike quantitative research, qualitative research prioritizes depth over volume. Usually, 5–12 participants are sufficient to reach "theoretical saturation," the point at which no new themes emerge from additional sessions.

**2. What should I do if a participant goes off-topic?**
Gently acknowledge their point to maintain rapport, then use a "pivot phrase" to bring them back to the research guide, such as: "That’s a really interesting point, and I’d love to explore that later if we have time, but I’d like to pivot back to [Topic] for a moment."
