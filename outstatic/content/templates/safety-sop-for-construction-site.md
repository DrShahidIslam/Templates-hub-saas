...
**Q: What should I do if I see an unauthorized visitor on-site?**
A: Immediately approach them to check for credentials. If they lack a site badge and escort, politely but firmly escort them to the site office for processing or off-site, and notify the Safety Officer immediately.

**Q: Is it acceptable to bypass a safety guard on a tool if it speeds up production?**
A: Absolutely not. Removing or bypassing safety guards is a fireable offense. If a guard hinders work, the task method must be re-evaluated by the Site Manager, not by modifying the equipment.
