...
**1. Can a contractor start work with only a CAC "interim" pass?**
No. Contractors may only commence work once their background investigation is successfully initiated and preliminary security requirements are met, and they have been fully briefed on the DHA Rules of Behavior.

**2. Who is responsible for renewing a contractor's CAC?**
The COR or the designated TASS sponsor is responsible for ensuring the contractor’s sponsorship is updated in the system prior to the CAC expiration date to prevent account lockout.
