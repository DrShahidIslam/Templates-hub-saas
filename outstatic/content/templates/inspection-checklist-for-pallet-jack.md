...
A: Do not use the equipment. Immediately remove the pallet jack from the floor, place a "DO NOT USE" tag on the handle, and notify your direct supervisor or the maintenance department to initiate a repair request.

**Q: How often does this inspection need to be performed?**
A: This inspection must be performed at the beginning of every shift, or whenever the equipment is handed over to a new operator.
