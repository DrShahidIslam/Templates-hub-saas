...
**Q: What should I do if a guest complains about their meal?**
A: Listen actively without interrupting, apologize sincerely, and immediately alert your floor manager. Never argue with the guest; focus on finding a solution that restores their satisfaction.

**Q: How do I handle a guest with a severe food allergy?**
A: Immediately confirm the allergy with the kitchen lead, ensure the order is marked "Allergy Alert" in the POS system, and personally verify with the chef that the preparation area is sanitized for that specific order.
