...
**1. How many universities should I include in my final list?**
A balanced list typically includes 2–3 "Reach" schools (highly competitive), 3–4 "Target" schools (aligned with your current profile), and 2 "Safety" schools (high likelihood of admission). 

**2. Should I contact the admissions office if I have a question?**
Yes, but only if the answer is not clearly stated on their website. Sending a concise, professional inquiry shows interest, but be mindful not to clutter their inbox with questions that could be self-researched.
