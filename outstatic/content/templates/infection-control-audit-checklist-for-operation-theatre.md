...
**Q: How often should biological indicator testing be performed for the autoclaves?**
A: Biological indicators (e.g., *Geobacillus stearothermophilus*) should be tested at least once a week, and ideally with every load containing an implantable device.

**Q: What is the recommended frequency for surface microbiological swabbing?**
A: Routine surface swabbing of OT walls and equipment is generally recommended quarterly. However, this frequency should increase if a cluster of SSIs is detected.
