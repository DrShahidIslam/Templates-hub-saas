...
**1. Who is primarily responsible for overseeing the annual year-end checklist?**
The Operations Manager is the primary owner, though department heads are responsible for completing the data-gathering and goal-setting sections for their respective teams.

**2. How should we handle data that is still "in progress" at the end of the year?**
Create a "Carryover" status for ongoing projects. Assign them a specific completion milestone in the new year's Q1 plan rather than marking them as failures or completions.
