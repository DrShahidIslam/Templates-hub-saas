...
**Q: What should I do if a patron reports a missing book that is listed as "Available" in the system?**
A: Immediately perform a "Search Request." Check the shelving area, the book return bin, the reshelving cart, and the hold shelf. If it is not found within 24 hours, update the status to "Missing" in the ILS to prevent further patron frustration.

**Q: How do we handle donated materials?**
A: All donations should be screened against the library’s collection development policy. Items that are outdated, in poor condition, or irrelevant to the local community should be diverted to the "Friends of the Library" book sale rather than being added to the active collection.
