...
**Q: How can I manage classroom prep when I have back-to-back classes with no break?**
A: Use a "reset squad"—a small group of student volunteers who assist in distributing materials or clearing stations during the final two minutes of class.

**Q: Should I document every minor behavioral issue during the day?**
A: Record patterns, not necessarily every single instance. Maintain a quick-reference "Communication Log" to track recurring behaviors, which provides objective data for parent meetings or administrative consultations.
