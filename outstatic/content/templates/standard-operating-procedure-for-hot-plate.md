...
**Q: Can I use an extension cord with my hot plate?**
A: Generally, no. Hot plates draw high current, and standard extension cords are often not rated for this load, creating a significant fire hazard. Always plug the unit directly into a wall outlet.

**Q: Why is my hot plate smoking when I turn it on?**
A: First, turn off the unit immediately. This is usually caused by chemical residue on the surface burning off. If no visible spills are present, the internal wiring may be faulty; discontinue use and contact maintenance for electrical testing.
