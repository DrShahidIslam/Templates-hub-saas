...
**Q: How often should the safety checklist be updated?**
A: While the daily checklist should remain consistent, the full SOP should be reviewed quarterly by the management team to account for new regulatory standards, updated equipment, or changing facility layouts.

**Q: What should I do if I find a broken item that is essential for the day?**
A: If an essential item is broken, it must be removed from use immediately. Do not attempt a "quick fix" with tape or glue if it compromises the integrity of the item. Notify your supervisor to request an immediate replacement or an alternative activity plan.
