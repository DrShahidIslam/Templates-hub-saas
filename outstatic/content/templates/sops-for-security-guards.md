...
**Q: What should I do if a high-ranking executive refuses to show their ID?**
A: Politely remind them of the security policy and explain that you are required to verify identification for everyone. If they persist, notify your direct supervisor immediately to handle the exception, but do not bypass the procedure yourself.

**Q: Am I authorized to use physical force?**
A: Generally, force is used only as a last resort in cases of self-defense or the protection of others. You must always use the minimum amount of force necessary and prioritize de-escalation at all times.
