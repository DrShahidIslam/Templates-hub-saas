...
**Q: What should I do if an inspection item requires a part that is currently out of stock?**
A: Document the deficiency in the system, mark the equipment as "Restricted Use" or "Out of Service" if applicable, and immediately submit a purchase request to the Procurement lead.

**Q: How long should we keep these daily records?**
A: All digital inspection logs must be archived for a minimum of three years to remain compliant with internal quality control standards and external safety audits.
