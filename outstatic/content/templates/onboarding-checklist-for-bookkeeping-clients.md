...
A: A standard onboarding should be completed within 10 to 14 business days, provided the client is responsive. 

**Q: What if the client's current books are a mess?**
A: If the "Health Check" reveals significant errors, stop the onboarding process and present a separate "Cleanup" engagement proposal. Do not start ongoing maintenance until the base data is accurate.
