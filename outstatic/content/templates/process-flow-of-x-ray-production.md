...
A: If the EI is too low (noisy image) or too high (potential patient over-exposure), evaluate your technical factor selection and collimation before repeating the exposure. Consult the manufacturer’s sensitivity chart.

**Q: How do I handle a patient who is unable to remain still for the exposure?**
A: Utilize immobilization devices (sponges, sandbags) or consider using a faster exposure time (higher mA, shorter time) to minimize the chance of motion artifact.
