...
**Q: What should I do if the image has motion blur?**
A: Motion blur indicates the patient moved during exposure. Re-assess the patient's comfort, repeat the breathing instructions clearly, and perform a repeat exposure only if the diagnostic quality is compromised.

**Q: Is it ever acceptable to skip the pregnancy screening?**
A: No. Pregnancy screening is a mandatory safety protocol. Even in emergency settings, the potential benefit must be weighed against the risk, and the radiologist must authorize the exam if the pregnancy status is unknown.
