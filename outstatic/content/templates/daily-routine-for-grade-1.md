...
**Q: How do I handle students who struggle with the transition between activities?**
A: Use a "First-Then" visual card. Explain that once the current activity (First) is finished, they are permitted to move to the next preferred activity (Then). This provides a tangible goal for the transition.

**Q: Should I change the daily routine if the students seem restless?**
A: You should adjust the *pace*, not the routine. If restlessness occurs, insert an unscheduled 3-minute physical movement break, but keep the structural flow of the day identical to maintain the feeling of safety.
