...
A: While rolling cycle counts are more efficient, a full wall-to-wall physical inventory count should be performed at least once per year for financial auditing and system baseline synchronization.

**Q: What should I do if I find a discrepancy that I cannot explain?**
A: Escalate the issue to the Operations Manager immediately. Do not force an adjustment. Document the discrepancy in the "Unresolved Variance Log" and trigger a secondary investigation by a different staff member.
