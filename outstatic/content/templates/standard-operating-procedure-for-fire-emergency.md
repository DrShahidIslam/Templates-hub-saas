...
**Q: What if I am in a meeting with external guests when the alarm sounds?**
A: You are responsible for ensuring that your guests evacuate with you. Lead them to the nearest exit and ensure they accompany you to the assembly point for the headcount.

**Q: Can I use a fire extinguisher on an electrical fire?**
A: Only if the extinguisher is rated for electrical fires (Class C). Look for the symbol on the extinguisher label. If you are unsure or the fire is too large, evacuate immediately.
