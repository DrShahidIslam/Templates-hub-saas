...
**Q: What should I do if the equipment fails one of the inspection points?**
A: Immediately remove the key, place an "Out of Service" tag on the controls, and notify your direct supervisor or the site safety officer. Do not attempt to "field repair" structural or safety-related items.

**Q: How often must this inspection be performed?**
A: This inspection must be performed before the start of every shift, or whenever the equipment is transferred to a new operator.
