...
**Q: What should we do if we find an asset that is not in the Fixed Asset Register?**
A: Treat this as an "Unrecorded Asset." Document the asset, determine its acquisition date and cost, and update the FAR immediately to ensure it is added to the depreciation schedule.

**Q: How do we handle "Ghost Assets" found during the audit?**
A: Ghost assets represent a major internal control failure. If they cannot be located, they must be written off through a formal disposal process, and the cause (theft, unrecorded disposal, or clerical error) must be investigated.
