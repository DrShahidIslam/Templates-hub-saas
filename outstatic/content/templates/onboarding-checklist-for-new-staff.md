...
## FAQ
**Q: How do we handle onboarding for fully remote employees?**
A: Use a virtual orientation "Welcome Room" via Zoom/Teams, ensure all hardware is shipped to arrive 2 days early, and schedule additional virtual coffee chats to replicate the social integration of an office.

**Q: Who is responsible if the IT provisioning fails?**
A: The Hiring Manager is ultimately responsible for the onboarding experience, even if IT tasks are delegated to a service desk or HR.
