...
**Q: How often should AHU preventive maintenance be performed?**
A: A general industry standard is quarterly for heavy-use environments (commercial offices) and semi-annually for low-use environments. However, filter replacements should be driven by pressure drop readings rather than calendar dates.

**Q: Why is my condensate pan constantly overflowing despite cleaning the drain?**
A: Check the P-trap configuration. If the trap is dry or improperly designed (negative pressure), it will prevent the water from draining effectively. Ensure the trap has sufficient depth to overcome the internal static pressure of the AHU.
