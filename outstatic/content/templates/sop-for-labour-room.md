...
**Q: What is the mandatory interval for vital sign monitoring during the active phase of labor?**
A: In low-risk pregnancies, maternal blood pressure and pulse should be recorded at least every 30-60 minutes, while fetal heart rate should be monitored every 15-30 minutes, depending on the phase of labor.

**Q: How should a "Code Pink" (Neonatal Emergency) be initiated?**
A: Activate the hospital's emergency call system immediately, specify the location, and initiate neonatal basic life support while waiting for the specialized resuscitation team to arrive.
