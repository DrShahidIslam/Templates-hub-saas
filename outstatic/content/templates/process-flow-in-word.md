...
**Q: Can I convert a bulleted list into a process flow automatically?**
A: Yes. Highlight your bulleted list, right-click, select "Convert to SmartArt," and choose your preferred process layout. Word will automatically map the list items to individual shapes.

**Q: Why does my process flow move around when I type text in the document?**
A: This happens because the object is set to "In Line with Text." Change the "Layout Options" to "Top and Bottom" or "Square" to lock the graphic in place relative to your text paragraphs.
