...
**1. What should I do if a patient’s vital signs are borderline?**
Always default to the higher acuity level. It is safer to over-triage a patient and have the provider downgrade them than to under-triage a patient who requires urgent intervention.

**2. How should I handle a patient who becomes aggressive during triage?**
Prioritize staff and patient safety. Utilize de-escalation techniques, maintain distance, and alert security or the charge nurse immediately. Do not attempt to complete the full assessment if the situation poses a threat to physical safety.
