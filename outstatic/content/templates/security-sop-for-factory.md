...
A: Access must be denied immediately. Security should escort the individual off the premises and inform the hosting employee or department head that the visitor was rejected.

**Q: How often should the digital access codes for the building be updated?**
A: Access codes and passwords should be rotated every 90 days or immediately following the termination of any employee who held administrative-level access.
