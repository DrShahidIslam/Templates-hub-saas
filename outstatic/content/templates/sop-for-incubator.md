...
**1. How long can I keep the incubator door open?**
Keep door openings under 15 seconds. If loading multiple samples, organize them on a sanitized tray outside the unit so you can load them in one single action.

**2. Why is there water condensation on the glass inner door?**
Mild condensation is normal due to the high humidity required for culture. However, excessive dripping indicates that the door gasket is failing or the room ambient temperature is too low. Check the seal for gaps.
