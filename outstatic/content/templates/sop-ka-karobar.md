...
**Q1: How do I manage credit (Udhaar) risk effectively?**
A: Implement a strict credit policy. Require a security deposit for new clients and set a hard limit on credit amounts. Use automated SMS reminders for payment deadlines to maintain professionalism.

**Q2: What should I do if my inventory levels are consistently incorrect?**
A: This usually indicates a lack of process at the warehouse level. Implement 'blind counting' where the counter does not know the expected number of items, and ensure every movement of stock is recorded at the point of entry/exit.
