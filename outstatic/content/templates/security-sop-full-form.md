...
**1. How often should a Security SOP be reviewed?**
At a minimum, Security SOPs should be reviewed annually. However, they should be updated immediately following any significant security breach, changes in facility infrastructure, or shifts in organizational management.

**2. Who is responsible for writing the Security SOP?**
The responsibility usually falls on the Security Manager or Operations Director, often in collaboration with subject matter experts (e.g., IT for cybersecurity, Safety Officers for fire protocols).
