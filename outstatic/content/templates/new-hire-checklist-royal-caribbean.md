...
**Q: What if a new hire's medical certificate expires mid-contract?**
A: It is the responsibility of the department head to flag expiration dates in the HRIS 60 days in advance. Medical updates must be scheduled at the next port-of-call that hosts an approved clinic.

**Q: How do we handle onboarding for remote shoreside staff versus shipboard crew?**
A: Shoreside staff focus on local labor law and corporate compliance, whereas shipboard onboarding is heavily prioritized toward SOLAS (Safety of Life at Sea) requirements and emergency response readiness.
