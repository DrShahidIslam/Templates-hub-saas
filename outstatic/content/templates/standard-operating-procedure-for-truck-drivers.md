...
**Q: What should I do if my ELD malfunctions during a trip?**
A: You must contact the maintenance department immediately to report the error and begin keeping manual paper logs. Ensure you have blank logs on hand in the cab at all times.

**Q: Am I authorized to use personal navigation apps for route planning?**
A: No. You must use the company-provided commercial GPS system. Personal apps often fail to account for truck-specific constraints such as weight limits, bridge heights, and truck-prohibited roads.
