...
**Q: What should I do if the patient is unable to follow breath-hold instructions?**
A: Use a "free-breathing" technique and utilize the "Cine" loop capture function to select the clearest frames from a series of images rather than trying to capture a single static frame during an inconsistent breath-hold.

**Q: How often should the ultrasound gel bottles be refilled?**
A: To prevent bacterial colonization, ultrasound gel should never be "topped off." The bottle should be completely emptied and cleaned/disinfected before being refilled or replaced with a new factory-sealed container.
