...
Q: Does the Pressure Flow Theory require energy?
A: Yes, it requires energy (ATP) for the active loading of sucrose into the sieve tubes at the source and potentially for unloading at the sink. The actual transport of the sap, however, is driven by hydrostatic pressure.

Q: What happens if the phloem is damaged or removed (Girdling)?
A: Sugar accumulates above the damaged site because it cannot reach the roots. This leads to swelling of the bark above the cut and eventually causes the roots to die due to lack of nutrients.
