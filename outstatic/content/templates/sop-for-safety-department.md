...
**Q: What is the primary priority when an incident occurs?**
A: Your primary priority is the stabilization of the injured person and the securing of the scene to prevent further injury or damage. Administrative documentation always comes secondary to medical safety.

**Q: How often should the Safety Department audit the facility?**
A: While daily walkthroughs are required, a comprehensive internal safety audit—covering all machinery, fire systems, and egress routes—must be performed at least quarterly.
