...
**1. How often should a department conduct an internal self-audit?**
Best practice dictates a quarterly internal review of high-risk areas (grants and P-Cards) and an annual comprehensive audit of all administrative and physical assets to remain in compliance with U-M internal control standards.

**2. What should I do if I discover a discrepancy during my audit?**
Do not attempt to hide the error. Document the finding, consult with your department's Financial Lead or the Office of Sponsored Programs (if applicable), and execute a correcting journal entry (with full documentation of the error) immediately.
