...
**Q: How often should I grease the drum bearings?**
A: Bearings should be greased according to the manufacturer’s interval—usually every 40 to 100 hours of operation. However, if the mixer is used in heavy dust or high-moisture environments, increase the frequency.

**Q: Can I use high-pressure water to clean the electrical control panel?**
A: No. Electrical panels are typically "dust-tight" or "splash-proof," not submersible. Use a damp cloth to wipe the exterior and compressed air to blow out dust from vents. Never spray water directly into the motor housing or control switches.
