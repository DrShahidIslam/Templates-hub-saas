...
**Q: How often should we conduct an emergency audit?**
A: Standard best practice is a formal audit every six months. However, specific components like fire extinguishers and AEDs must follow monthly or quarterly inspection schedules defined by the manufacturer or local fire code.

**Q: Who should be responsible for conducting the audit?**
A: The audit should be led by the Operations Manager or Safety Officer, ideally supported by a cross-functional committee including HR (for employee records) and Facilities (for infrastructure maintenance).
