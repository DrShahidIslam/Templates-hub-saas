...
**Q: What is the mandatory time frame for reprocessing an endoscope after use?**
A: Reprocessing should begin immediately after the procedure. If the scope sits for more than 30–60 minutes without pre-cleaning, the bioburden may harden, necessitating a more rigorous manual cleaning cycle.

**Q: Can I use tap water for the final rinse of the endoscope?**
A: No. A final rinse must be performed using filtered or sterile water to prevent the introduction of opportunistic pathogens like *Pseudomonas* into the cleaned channels.
