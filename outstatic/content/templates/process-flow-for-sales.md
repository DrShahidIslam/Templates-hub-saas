...
**Q: What should I do if a prospect goes silent after the proposal?**
A: Follow the "Three-Touch" rule. Send a polite follow-up at 3 days, 7 days, and 14 days. If there is no response after the third attempt, move the lead to "Nurture" status and stop active pursuit until a marketing trigger brings them back.

**Q: How do I handle a request for a discount that exceeds my authority?**
A: Never agree to a discount on the spot. Respond by stating, "I need to review our current pricing structures and consult with management to see if that fits within our parameters." This buys you time to calculate the ROI impact and protects your margins.
