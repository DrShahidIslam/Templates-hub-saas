...
**Q: What happens if my robot fails the initial inspection?**
A: You will be given a "Fix-It" list by the inspector. You must return to your pit, address the non-compliance issues, and return to the inspection station for a re-inspection before you are permitted to compete.

**Q: Can I use VEX IQ parts on a VEX V5 robot?**
A: Generally, no. VEX V5 and VEX IQ are separate ecosystems. Only parts specifically listed as "VRC Legal" in the current Game Manual appendices are permitted.
