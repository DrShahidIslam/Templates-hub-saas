...
**Q: How long can a urine specimen sit before it is no longer valid for microscopy?**
A: Ideally, microscopy should occur within 2 hours. After 2-4 hours at room temperature, cells begin to lyse, and bacterial overgrowth may alter the chemical and cellular environment, compromising accuracy.

**Q: What is the significance of "squamous epithelial cells" in a sample?**
A: Large numbers of squamous epithelial cells usually indicate a poorly collected (non-midstream) specimen contaminated by skin flora. It suggests the sample may not be representative of the bladder environment.
