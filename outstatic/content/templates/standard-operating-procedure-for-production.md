...
## FAQ
**Q: What should I do if the machinery breaks down mid-shift?**
A: Immediately initiate the "Stop, Call, Wait" protocol: stop the machine, call the shift supervisor and maintenance department, and wait for authorized personnel to assess the repair.

**Q: How do we handle raw materials that are slightly out of specification?**
A: Do not use the material. Tag the batch as "Non-Conforming," isolate it from the production floor, and contact the Quality Control manager for a formal disposition.
