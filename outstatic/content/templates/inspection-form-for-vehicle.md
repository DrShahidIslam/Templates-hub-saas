...
**Q: What should I do if I find a defect that is not listed on the inspection form?**
A: Use the "Comments/Notes" section of the report to provide a detailed description of the issue. Notify your fleet manager immediately, regardless of whether the vehicle is "drivable" or not.

**Q: How often must these inspections be filed?**
A: Inspections must be completed and submitted at the start of every shift. If the vehicle is used for multiple shifts, each operator must conduct their own inspection.
