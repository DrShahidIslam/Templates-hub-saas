...
**1. How often should a critical pharmaceutical vendor be audited?**
Critical vendors (e.g., API manufacturers) typically require a formal onsite audit at least every 2 to 3 years, supplemented by annual remote performance reviews (Quality Agreements and QBRs).

**2. What is the difference between a 'Major' and 'Critical' finding?**
A 'Critical' finding indicates a direct risk to patient safety or product efficacy (e.g., falsified data). A 'Major' finding is a breakdown in the QMS that does not immediately impact product quality but presents a significant risk of doing so if left unaddressed.
