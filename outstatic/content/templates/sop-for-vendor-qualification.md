...
**Q: How often must an approved vendor be re-qualified?**
A: We conduct a "Light Refresh" annually for all vendors and a comprehensive re-qualification audit every 36 months, or immediately upon a change in company ownership or service scope.

**Q: Can we fast-track a vendor if there is an emergency?**
A: Yes, but only with a signed "Emergency Waiver" from both the CFO and the head of the requesting department. An emergency waiver is valid for 90 days, after which full qualification must be completed.
