...
**Q: How often should the eyewash station be flushed?**
A: Regulatory standards typically require a weekly flush to clear stagnant water and rust from the lines, preventing eye contamination during an emergency.

**Q: What is the most critical step if a chemical spill occurs?**
A: Ensure your own safety first. Evacuate the immediate area, alert colleagues, and consult the Safety Data Sheet (SDS) before attempting to neutralize or contain the spill.
