...
**1. What should I do if an applicant accidentally includes their name in the document?**
The document should be flagged by the initial screener (not the evaluator). The Integrity Officer should sanitize the file before it reaches the evaluation stage to maintain the integrity of the blind review.

**2. Does faceless assessment prevent all forms of bias?**
No. While it eliminates explicit bias (e.g., gender, race, age), it cannot eliminate bias regarding the quality of the work or the style of the content. It remains a tool for structural fairness, not a substitute for ethical judgment.
