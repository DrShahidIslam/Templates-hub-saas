...
## FAQ
**Q: How often must impairment testing be performed?**
A: Testing must be performed whenever there is an "indicator" of impairment. For intangible assets with indefinite useful lives or goodwill, testing is mandatory at least annually, regardless of whether indicators exist.

**Q: Can impairment losses be reversed?**
A: Under IFRS (IAS 36), impairment losses for assets other than goodwill can be reversed if there is a change in the estimates used to determine the recoverable amount. Under US GAAP (ASC 360), impairment losses on assets held for use generally cannot be reversed.
