...
**Q: What is the most important rule in food safety?**
A: The most important rule is the prevention of cross-contamination. Always wash hands and change gloves when moving from raw ingredients to ready-to-eat foods or cooked products.

**Q: How do I handle a food delivery that arrives at an improper temperature?**
A: Reject the delivery immediately. Document the temperature discrepancy on the invoice, notify the vendor, and inform the kitchen manager so that an alternative ingredient source can be utilized.
