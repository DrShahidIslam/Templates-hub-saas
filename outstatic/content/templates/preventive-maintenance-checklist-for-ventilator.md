...
A: Most manufacturers recommend a full preventive maintenance cycle every 6 to 12 months, depending on usage intensity. Always defer to the specific model's Service Manual.

**Q: What should I do if the oxygen sensor fails to calibrate during PM?**
A: First, allow the sensor to stabilize in room air for 15 minutes. If it still fails, replace the sensor cell entirely. Never attempt to "force" a calibration on a degraded sensor.
