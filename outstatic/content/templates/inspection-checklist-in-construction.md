...
**Q: How often should formal site inspections be conducted?**
A: Formal inspections should occur at every critical milestone (e.g., pre-pour, pre-drywall, pre-occupancy). Daily "walk-throughs" should occur regardless of milestone status to monitor safety and progress.

**Q: What should I do if I find a major code violation on-site?**
A: Immediately issue a "Stop Work" order for the affected area, document the violation with photos, notify the General Contractor and the relevant Subcontractor, and do not allow work to resume until a corrective action plan is approved.
