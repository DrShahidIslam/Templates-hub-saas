...
**Q: How often should I replace the autoclave gasket?**
A: Under normal usage, replace the gasket every 6–12 months. However, replace it immediately if you notice steam leaking around the door or if the autoclave fails to reach or maintain full sterilization pressure.

**Q: Can I use standard bleach to clean the stainless steel chamber?**
A: No. Never use chlorine-based bleach, steel wool, or abrasive pads. Chlorine causes severe pitting and corrosion of stainless steel, which will compromise the pressure vessel's integrity over time. Use only manufacturer-recommended chamber cleaners.
