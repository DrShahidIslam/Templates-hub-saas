...
**Q: How should we handle a parent who is running late for pickup?**
A: Follow your facility’s late-pickup policy strictly. Attempt to call the parents and then move through your emergency contact list. Ensure the child is kept comfortable and engaged in a quiet activity until an authorized person arrives.

**Q: What is the procedure if a child refuses to nap?**
A: Never force a child to sleep. Provide a "quiet time" bin with books or soft fidget toys that can be used on their cot. Ensure they remain quiet so as not to disturb other sleeping children.
