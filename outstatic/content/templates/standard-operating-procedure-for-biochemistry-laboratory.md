...
**Q: What should I do if there is a minor chemical spill?**
A: Immediately alert nearby personnel. Consult the SDS to determine if the spill requires specialized neutralizers. Use the laboratory spill kit to contain the spill, clean it starting from the perimeter moving inward, and report the incident to the Lab Manager.

**Q: How often should the laboratory eye-wash station be flushed?**
A: All eye-wash stations should be flushed weekly for at least three minutes to clear stagnant water and rust from the pipes. Ensure the flow is consistent and the handles move freely.
