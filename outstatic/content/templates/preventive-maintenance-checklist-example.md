...
**1. What should I do if I find a defect not listed on the PM checklist?**
Immediately document the finding as a "Corrective Action" in the CMMS. If the defect poses an immediate safety risk, stop the PM, tag the machine as "Out of Service," and alert your supervisor.

**2. How frequently should preventive maintenance be performed?**
PM frequency should be based on a combination of manufacturer recommendations, equipment run-hours, and environmental severity (e.g., high-dust or high-heat environments require more frequent intervals).
