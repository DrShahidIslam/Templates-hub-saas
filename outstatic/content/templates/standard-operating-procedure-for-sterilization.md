...
**Q: How long can a sterilized instrument be stored?**
A: Sterility is event-related, not time-related. If the packaging integrity is maintained (no tears, moisture, or punctures), the item remains sterile indefinitely. However, check institutional policies regarding shelf-life limits.

**Q: Why must instruments be dried before sterilization?**
A: Residual moisture can dilute chemical disinfectants or interfere with steam sterilization. Furthermore, trapped moisture can cause "wet packs," which are a primary cause of microbial contamination after the cycle finishes.
