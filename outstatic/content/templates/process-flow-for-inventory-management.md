...
A: While daily cycle counting is preferred to keep accuracy high, a full physical inventory count should be performed at least annually (or quarterly for high-volatility businesses) to reconcile discrepancies.

**Q: What is the most common cause of inventory shrinkage?**
A: Administrative error is the primary culprit. This includes failing to scan items upon arrival, inputting incorrect quantities into the system, or neglecting to log internal stock transfers.
