...
**1. What should I do if the participant is deemed to lack the capacity to consent?**
If a participant lacks capacity, you must identify a legally authorized representative (LAR) or healthcare proxy. The consent process remains the same, but the discussion and signature requirements shift to the authorized individual.

**2. Is a witness always required during the signing process?**
While requirements vary by local regulation, it is best practice to have a witness present for all signatures, especially for complex or high-risk procedures, to verify that the consent was provided freely and voluntarily.
