...
**Q: What is the most critical item an auditor looks for in the QC lab?**
A: Data Integrity. Auditors prioritize evidence that test results are accurate, attributable, and were not manipulated to meet specifications.

**Q: How far back should our training records go?**
A: Training records should be maintained for the duration of the employee's tenure plus at least one year. Ideally, maintain the complete training history to demonstrate ongoing competency.
