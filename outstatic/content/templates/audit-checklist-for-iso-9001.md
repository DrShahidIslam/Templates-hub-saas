...
A: ISO 9001 requires internal audits to be conducted at planned intervals. Most organizations perform a full system audit annually, though many choose to audit high-risk or core processes quarterly or bi-annually.

**Q: What if we find a non-conformity in a core process?**
A: Do not panic. A non-conformity is an opportunity for improvement. Document the finding, perform a root cause analysis, implement a corrective action, and verify the effectiveness of that action before closing the file.
