...
**Q: How frequently should an AP audit be conducted?**
A: A full-scale audit should be performed annually. However, performing "spot checks" on a monthly or quarterly basis is highly recommended to catch systemic errors before they become significant financial risks.

**Q: What is the most common finding during an AP audit?**
A: The most frequent finding is usually "duplicate payments" caused by vendors submitting the same invoice in different formats (e.g., PDF vs. physical mail) or internal processing errors.
