...
**Q: How often should a machine undergo a full maintenance cycle?**
A: Frequency is determined by the manufacturer’s duty cycle specifications and the operational environment (e.g., high-dust environments require more frequent filter changes). Refer to the machine’s specific maintenance schedule provided in the manual.

**Q: What should I do if I find a fault not listed in the checklist?**
A: Immediately document the anomaly in the maintenance logbook, notify the Operations Manager, and do not restart the machine until the specific fault has been rectified or assessed by a technician.
