...
**1. Should a supervisor have administrative access on Day 1?**
No. It is recommended to grant access gradually as the supervisor completes their security and compliance training modules to mitigate risk.

**2. What if a supervisor is an internal hire? Do they still need the full orientation?**
Yes. While they may know the company culture, they require specialized training for their new level of authority, access to new management-level data, and a shift in their professional identity from "peer" to "leader."
