...
**Q: How do I handle a toddler who refuses to follow the schedule?**
A: Validate their emotion ("I see you want to keep playing"), but maintain the boundary ("It is time for lunch now"). Use a timer to provide a concrete end-point to their current activity.

**Q: What should I do if the nap time is missed?**
A: Adjust the evening schedule by moving bedtime 30–60 minutes earlier. An overtired toddler will struggle with cortisol spikes, making sleep more difficult, so recovery sleep is the priority.
