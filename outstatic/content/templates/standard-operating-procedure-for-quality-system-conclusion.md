...
**Q: What happens if an item is still "In-Progress" during the conclusion phase?**
A: Items that cannot be completed by the conclusion deadline must be formally risk-assessed, documented as a pending carry-over, and assigned a hard deadline in the next cycle’s quality plan.

**Q: Is a physical signature required for the Quality System Conclusion?**
A: Depending on your regulatory environment (e.g., FDA 21 CFR Part 11), a validated electronic signature is typically sufficient and preferred for auditability. Ensure your system meets local legal requirements for digital signatures.
