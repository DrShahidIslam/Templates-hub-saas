...
**Q1: How do I handle a batch that fails the color match test?**
A: Never attempt to adjust color without approval from the Lead Colorist. Always calculate adjustments based on a small lab-scale mock-up before adding colorants to the main production vessel to avoid over-shooting the shade.

**Q2: What is the most critical factor for maintaining dispersion stability?**
A: Maintaining the correct "mill base" viscosity. If the base is too thin during the grinding phase, you won't get enough shear force to break down pigment clumps. If it is too thick, the pigment will not be effectively wetted.
