...
**Q: Can we keep the rear emergency exit locked for security reasons?**
A: Absolutely not. Emergency exits must be readily openable from the inside without the use of a key, special knowledge, or effort at all times while the building is occupied.

**Q: What should I do if I find an emergency exit blocked by a contractor?**
A: Stop the work immediately and inform the contractor that the exit must remain clear. Notify the Facilities Manager so they can reiterate the safety policy to the vendor’s management.
