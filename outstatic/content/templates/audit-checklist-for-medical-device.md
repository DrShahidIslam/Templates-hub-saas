...
**Q: How often should a medical device company perform an internal audit?**
A: Per ISO 13485, internal audits must be conducted at "planned intervals." Most high-performing organizations perform a full system audit once per year, with smaller "spot audits" conducted quarterly.

**Q: What is the most critical item to have ready during an audit?**
A: The CAPA log and the Management Review minutes. These two documents provide an overview of the company’s "Quality Culture" and indicate whether management is aware of and actively addressing system weaknesses.
