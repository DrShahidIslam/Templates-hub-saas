...
A: A comprehensive UX onboarding typically spans 30 days, with the first week focusing on tools/systems and the following three weeks focusing on product context and task execution.

**Q: Should I assign the new hire a major project immediately?**
A: No. It is highly recommended to assign a "quick win" task first to allow the designer to learn your specific file structure and approval processes before taking on high-visibility work.
