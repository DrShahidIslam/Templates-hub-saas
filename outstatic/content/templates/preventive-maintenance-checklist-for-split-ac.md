...
A: In residential settings, semi-annually (once before summer and once before winter) is standard. In dusty environments or high-usage commercial areas, perform maintenance quarterly.

**Q: Should I use a coil cleaner on the indoor unit while it is installed?**
A: Yes, but only with a specialized no-rinse foam cleaner and a catch-pan/tarp installed below the unit to protect walls and flooring from runoff.
