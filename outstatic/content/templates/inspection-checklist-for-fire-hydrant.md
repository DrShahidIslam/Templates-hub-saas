...
A: Standard industry practice and NFPA 25 guidelines dictate that fire hydrants should be inspected and flow-tested at least annually, or as directed by the local Authority Having Jurisdiction (AHJ).

**Q: What should I do if I find a hydrant that is difficult to open?**
A: Do not force it. Mark the hydrant as "Out of Service" with a standard red tag, notify your supervisor immediately, and contact the local water utility department to initiate a mechanical repair.
