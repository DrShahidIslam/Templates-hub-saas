...
**Q: What should I do if an inspector asks a question I do not know the answer to?**
A: Never guess. Politely inform the inspector that you want to ensure the accuracy of the information and will consult with the relevant department lead to provide the correct answer promptly.

**Q: Should I stop normal operations during an inspection?**
A: Generally, no. Most inspectors prefer to see a "live" operation to verify that safety protocols are followed under normal working conditions. Only stop operations if an immediate safety hazard is identified.
