...
**Q: How often should the finance team perform a bank reconciliation?**
A: Bank reconciliations should be performed weekly to ensure discrepancies are identified and resolved before the formal month-end close.

**Q: What is the procedure if a duplicate payment is discovered?**
A: Immediately contact the vendor to request a credit memo for the duplicate amount, then notify the Controller to reverse the entry in the ledger.
