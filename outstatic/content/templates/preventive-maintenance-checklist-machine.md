...
A: Frequency is determined by the manufacturer’s recommendation and the machine's duty cycle. High-utilization machines typically require daily/weekly "mini-inspections" and quarterly comprehensive overhauls.

**Q: What should I do if I find a defect during the inspection that isn't on the checklist?**
A: Immediately document the defect in the maintenance log, notify your shift supervisor, and generate a work order for a corrective maintenance follow-up. Do not clear the machine for production if the defect affects safety.
