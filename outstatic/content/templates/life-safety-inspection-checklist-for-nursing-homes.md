...
**1. How often should we conduct internal Life Safety inspections?**
While CMS requires annual formal inspections by qualified professionals, internal "walk-through" inspections should be conducted at least monthly to identify and remediate hazards before they become formal citations.

**2. Can we use a piece of furniture to prop open a fire door if it is in a low-traffic area?**
No. Fire doors must be self-closing and self-latching at all times. If a door must be held open for accessibility, it must be equipped with an integrated electromagnetic release system that closes the door automatically upon fire alarm activation.
