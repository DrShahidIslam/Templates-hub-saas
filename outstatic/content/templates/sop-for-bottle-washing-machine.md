...
**Q: How often should the wash nozzles be inspected?**
A: Nozzles should be inspected for mineral blockage and misalignment at the start of every shift and deep-cleaned during the weekly maintenance window.

**Q: What should I do if the machine emits a foul odor?**
A: A foul odor usually indicates bacterial buildup in the sump tank or a blocked drainage filter. Immediately cease operations, initiate a deep clean of the internal tanks, and ensure the filtration system is clear.
