...
**Q: How often should a store audit be performed?**
A: Store Managers should conduct a full "deep-dive" audit at least once per week. District Managers should perform a formal, unannounced audit at least once per month to ensure objective reporting.

**Q: What should I do if I find a significant inventory discrepancy?**
A: First, double-check for recent shipment processing errors or mislabeled items. If the discrepancy persists, initiate a cycle count for that category and report the findings to the Loss Prevention department for further investigation.
