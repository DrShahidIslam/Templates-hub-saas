...
**1. How often should ventilator circuit checks be performed?**
Ventilator circuits and settings must be assessed every 2 hours and whenever a change in patient status or clinical distress is observed.

**2. What is the protocol for a discrepancy in sedation orders?**
If there is a conflict between the medication administration record (MAR) and current patient status, verify the order with the attending physician immediately before titrating any sedative or analgesic infusion.
