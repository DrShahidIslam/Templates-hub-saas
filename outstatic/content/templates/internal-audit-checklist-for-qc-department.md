...
**Q: How often should an internal QC audit be conducted?**
A: Typically, internal audits should be performed at least annually. However, if the department undergoes significant changes (e.g., new equipment, new software, or process overhaul), an ad-hoc audit should be scheduled immediately.

**Q: What is the correct protocol when a discrepancy is discovered during an audit?**
A: All discrepancies must be documented as "Findings" or "Non-conformances." You must categorize them by severity, assign a corrective action plan (CAPA) with a clear owner, and set a realistic deadline for resolution.
