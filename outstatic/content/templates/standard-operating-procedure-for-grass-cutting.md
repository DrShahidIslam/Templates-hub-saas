...
**Q: How often should we sharpen the mower blades?**
A: Ideally, blades should be sharpened every 20–25 hours of use. If you notice the grass tips look frayed or white after cutting, your blades are dull and require immediate service.

**Q: What should we do if we encounter an irrigation head or utility marker?**
A: Always flag known obstacles before starting. If you strike an object, stop immediately, disengage the blades, and inspect the equipment for damage before resuming. Report any damaged property to the site supervisor immediately.
