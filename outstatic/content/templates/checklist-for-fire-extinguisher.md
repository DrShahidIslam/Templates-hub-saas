...
**Q: How often should fire extinguishers be professionally serviced?**
A: Regardless of monthly self-inspections, all fire extinguishers must undergo an annual maintenance check by a licensed fire protection company. Additionally, internal maintenance (hydrostatic testing) is required every 5 to 12 years, depending on the extinguisher type.

**Q: What do I do if I find an extinguisher with a broken tamper seal?**
A: Even if the gauge is in the green, a broken seal suggests the unit may have been tampered with or partially discharged. You must remove it from service immediately, notify the Safety Officer, and replace it with a fully charged unit.
