...
**Q: What should I do if the document is slightly blurry but the data is legible?**
A: If the primary identifiers (Name, ID number, Expiry) are clear, you may proceed, but flag the file as "Low Resolution" in your notes. If the blurriness obscures any security features or critical text, request a resubmission.

**Q: How do I handle a document that appears legitimate but lacks a physical stamp or seal?**
A: Consult the "Accepted Document List" for that specific document type. If a seal is a requirement for validity in that jurisdiction, mark the submission as rejected and request a certified copy.
