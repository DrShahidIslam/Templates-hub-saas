...
**Q: What should I do if the security cameras go offline?**
A: Immediately log the downtime in the maintenance registry, switch to a physical "roving watch" protocol until the system is restored, and contact the IT department to troubleshoot the network connection.

**Q: Are temporary employees required to undergo the same security vetting?**
A: Yes. All personnel, including contractors and temporary workers, must follow the same identification and access protocols as full-time staff without exception.
