...
**Q: What should we do if we find damaged inventory during the count?**
A: Do not include damaged or expired goods in your "sellable" count. Record them separately on a "Damaged Goods" log so they can be disposed of or returned to the vendor following the count.

**Q: Should we halt all operations during the count?**
A: Yes. If inventory is in constant motion, you will suffer from "in-transit errors." A physical count is a snapshot in time; it cannot be accurate if goods are moving in or out during the process.
