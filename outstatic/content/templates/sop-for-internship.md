...
**Q: How do we handle performance issues with an intern?**
A: Address performance concerns immediately through the mentor. If performance does not improve after a documented feedback session, involve HR to determine if the internship should be terminated.

**Q: Are interns required to attend all company meetings?**
A: Interns should attend meetings that are relevant to their projects or offer significant learning value. Avoid overloading their schedules with high-level administrative meetings that do not pertain to their scope of work.
