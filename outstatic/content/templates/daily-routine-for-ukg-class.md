...
**Q: How do I handle students who struggle with transitions between activities?**
A: Use a 5-minute and 2-minute verbal warning system. Supplement this with visual cues, such as flashing the lights or playing a specific transition song, so students know exactly when the change is occurring.

**Q: What is the best strategy for managing small group rotations?**
A: Use a color-coded rotation chart displayed on the wall. Keep the rotations short (no more than 15-20 minutes) and ensure the "Independent" group has tasks they can complete without adult intervention.
