...
**Q: How often should electrical safety testing be performed?**
A: Electrical safety testing must be performed upon initial receipt, after any repair that involves the chassis or electrical circuitry, and during every scheduled preventative maintenance cycle.

**Q: What is the required protocol if a device fails a PM test?**
A: The device must be immediately removed from service, tagged with a "DO NOT USE" label, and transferred to the BME shop for corrective maintenance. It cannot return to service until it passes all functional and safety tests.
