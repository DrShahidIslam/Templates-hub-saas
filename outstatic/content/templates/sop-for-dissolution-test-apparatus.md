...
**Q: How often should the apparatus be mechanically calibrated?**
A: Typically, performance verification must be conducted every 6 months or after any significant maintenance or relocation of the equipment, in accordance with your internal Quality Management System and USP requirements.

**Q: What should I do if a vessel crack is discovered during testing?**
A: Immediately stop the test, invalidate the run, document the finding in the laboratory logbook, and notify the Quality Assurance department. The affected vessel must be replaced and the equipment re-calibrated before further use.
