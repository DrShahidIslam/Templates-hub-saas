...
**1. How often should safety SOPs be reviewed?**
At a minimum, they should be reviewed annually. However, any change in equipment, processes, or an incident occurrence should trigger an immediate "ad-hoc" review.

**2. What should I do if a team member suggests an improvement to the safety procedure?**
Acknowledge the feedback immediately, document it, and conduct a mini-risk assessment. If the change improves safety, incorporate it into the next version of the SOP and notify all relevant staff.
