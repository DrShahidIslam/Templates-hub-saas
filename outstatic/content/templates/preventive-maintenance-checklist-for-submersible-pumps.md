...
A: In standard clean water applications, a semi-annual inspection is recommended. For wastewater or abrasive fluid applications, maintenance should be performed quarterly or based on specific runtime (e.g., every 2,000 operational hours).

**Q: Why is my oil sample milky?**
A: Milky oil is a classic sign of water emulsification. This indicates that the mechanical seal has been compromised, allowing fluid from the pump volute to enter the oil chamber. The seal set must be replaced immediately to prevent motor winding damage.
