...
## FAQ
**Q: What should I do if a hazardous waste container is leaking?**
A: Immediately cordon off the area, alert your supervisor, and use the facility-provided spill kit to contain the liquid. Do not attempt to move the container until it has been safely neutralized or over-packed by a trained technician.

**Q: Can I put coffee cups in the recycling bin?**
A: No. Most single-use coffee cups have a thin plastic lining that makes them non-recyclable. These must be disposed of in the general landfill waste bin.
