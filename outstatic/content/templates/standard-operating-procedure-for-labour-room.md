...
**1. What should be the immediate reaction to a non-reassuring fetal heart rate?**
Immediately reposition the mother (left lateral), increase intravenous fluids, administer supplemental oxygen if required, discontinue oxytocin (if infusing), and notify the senior obstetrician on duty for urgent evaluation.

**2. How often should the Partograph be updated?**
In the active phase of labor, vaginal examinations should be recorded at least every 4 hours, and fetal heart rate should be monitored every 30 minutes. The Partograph must be updated concurrently with these assessments.
