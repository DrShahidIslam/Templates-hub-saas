...
**1. What should I do if the autoclave displays an error code?**
Do not attempt to override or reset the error. Immediately place an "Out of Service" sign on the unit, record the specific error code, and notify the laboratory manager or maintenance department.

**2. Can I autoclave items containing solvents or volatile chemicals?**
No. Autoclaving hazardous, flammable, or volatile chemicals is strictly prohibited, as they can create toxic fumes or explosive conditions within the pressurized chamber.
