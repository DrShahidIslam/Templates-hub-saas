...
**Q: How do we handle applications that are missing a critical document?**
A: Place the file in "Pending" status and set an automated follow-up trigger. Do not move to the Underwriting stage until 100% of the initial document request has been fulfilled.

**Q: What is the standard timeframe for a conditional approval?**
A: For a standard application, the goal is to reach conditional approval within 3–5 business days, assuming the borrower provides all documentation promptly.
