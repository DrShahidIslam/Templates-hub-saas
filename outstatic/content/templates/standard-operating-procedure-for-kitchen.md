...
**Q: What is the mandatory procedure if a refrigerator temperature is above 41°F (5°C)?**
A: Immediately notify the kitchen manager. If the temperature cannot be corrected within one hour, all perishable items must be moved to a functional unit or discarded, and the unit must be taken out of service for maintenance.

**Q: How do we handle food that has lost its date label?**
A: All unlabeled food must be discarded immediately. Never guess the age of an ingredient; "When in doubt, throw it out."
