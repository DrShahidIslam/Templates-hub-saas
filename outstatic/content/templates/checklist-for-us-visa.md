...
**Q: Do I need to provide flight tickets or hotel bookings?**
A: It is strongly recommended to provide tentative travel plans or confirmed bookings, but do not purchase non-refundable airfare until your visa is physically stamped in your passport.

**Q: What happens if I make a mistake on the DS-160?**
A: If the error is minor (e.g., a typo), you can often correct it at the biometrics center. If the error is substantive (e.g., dates of birth, travel history), you must complete a new DS-160 and bring both the old and new confirmation pages to the interview.
