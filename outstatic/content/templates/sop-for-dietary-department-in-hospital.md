...
**Q: What should I do if a patient’s diet order seems inconsistent with their medical condition?**
A: Do not serve the meal. Immediately contact the Clinical Dietitian or the patient's Charge Nurse to verify the order before proceeding.

**Q: How often must we audit the food temperature logs?**
A: Temperature logs must be audited daily by the Dietary Supervisor to ensure compliance with health department regulations and internal safety standards.
