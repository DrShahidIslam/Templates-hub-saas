...
**Q: How often should this checklist be reviewed and updated?**
A: This checklist should be reviewed quarterly to ensure it remains aligned with current site phases (e.g., transition from earthworks to structural framing) and updated whenever new hazards are introduced.

**Q: What is the mandatory course of action if a critical deficiency is found?**
A: If a critical hazard is identified, work in that specific area must be suspended immediately. Flag the area, notify the Project Manager, and document the deficiency in the safety log. Work cannot resume until the hazard is remediated and re-inspected.
