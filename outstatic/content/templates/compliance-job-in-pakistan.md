...
**Q1: What is the most common reason for a company to face an FBR audit?**
A1: The most common trigger is a mismatch between declared sales in the Sales Tax Return and the revenue reported in the Income Tax Return, or sudden fluctuations in input tax claims.

**Q2: How often should we update our AML/CFT policy?**
A2: Policies should be reviewed annually or whenever the FATF (Financial Action Task Force) or the State Bank of Pakistan updates their guidelines regarding the national risk assessment.
