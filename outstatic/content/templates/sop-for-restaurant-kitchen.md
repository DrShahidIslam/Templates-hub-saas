...
**Q: What should I do if a piece of equipment is malfunctioning?**
A: Immediately alert the Kitchen Manager or Chef on duty. Do not attempt to "jury-rig" a repair. Place an "Out of Order" sign on the equipment and fill out a maintenance request form.

**Q: What is the procedure if a customer reports an allergen issue?**
A: Stop all production immediately. The Chef must personally oversee the preparation of that order using cleaned/sanitized equipment, and the dish must be delivered by a manager to ensure clear communication.
