...
**Q: How often should an internal project audit be conducted?**
A: For standard projects, a quarterly audit is recommended. For high-risk or high-budget initiatives, monthly audits are preferred to ensure early detection of variances.

**Q: What is the most critical document to check during an audit?**
A: The Change Request Log. It acts as the "source of truth" for how the project evolved from its original charter, revealing if scope creep is being managed effectively.
