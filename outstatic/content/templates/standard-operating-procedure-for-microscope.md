...
**Q: My image is blurry regardless of focus adjustments. What is the cause?**
A: Most commonly, this is due to a smudge or fingerprint on the eyepiece or objective lens. Clean all optical surfaces with lens paper and check if the slide is upside down.

**Q: Can I use ethanol or alcohol-based cleaners on the microscope?**
A: Use only manufacturer-recommended lens cleaners. Standard household glass cleaners (like Windex) contain ammonia, which can strip the anti-reflective coatings off the lens surfaces.
