...
**Q: How often must we conduct an internal audit?**
A: ISO 9001 does not set a hard frequency, but it does require an audit program that is risk-based. Most organizations perform a full internal audit of all processes at least once per 12-month cycle.

**Q: Can I audit my own department if I am the Quality Manager?**
A: No. ISO 9001 specifically requires that "auditors shall not audit their own work." This ensures the objectivity and impartiality of the audit process. You should swap audit responsibilities with another qualified staff member or use an external consultant.
