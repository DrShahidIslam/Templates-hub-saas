...
A: You should test the bilge pump manually before every departure by using the manual override switch. Additionally, check the intake for debris or clogs at least once a month.

**Q: What is the most critical item to check in the mechanical system?**
A: The fuel system. Leaks are the primary cause of engine fires and sudden engine failure. Always inspect fuel hoses for "weather checking" or cracks, and ensure the clamps are tight.
