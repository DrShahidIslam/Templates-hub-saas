...
**Q: What is the procedure if the ambulance breaks down while transporting a patient?**
A: Immediately notify dispatch to request a secondary ambulance and a paramedic intercept if necessary. Maintain patient stability until the backup unit arrives for a safe transfer of care.

**Q: How should a crew handle a patient who refuses transport?**
A: You must document that the patient is alert, oriented, and fully informed of the risks of refusing care. Always consult with medical control (a physician) via radio before finalizing a refusal of transport.
