...
**Q: Why is my DNA ladder smeary rather than consisting of distinct bands?**
A: This is often caused by degradation of the DNA sample due to DNase contamination, or by running the gel at an excessively high voltage for the buffer type used.

**Q: Can I reuse the electrophoresis buffer?**
A: You may reuse the buffer in the tank 2-3 times, but it is recommended to discard it if you notice a change in pH or if the run times become inconsistent.
