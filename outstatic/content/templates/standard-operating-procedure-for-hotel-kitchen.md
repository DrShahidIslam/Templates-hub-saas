...
**Q: What should I do if a guest reports a food allergy?**
A: Immediately stop all preparation for that order. Notify the Sous Chef, use dedicated/sanitized equipment, and ensure the dish is prepared under strict supervision to prevent cross-contact.

**Q: How often must we record temperatures of the walk-in coolers?**
A: Temperatures must be logged at least three times per shift (beginning, middle, and end) and signed off by a supervisor to ensure compliance with health codes.
