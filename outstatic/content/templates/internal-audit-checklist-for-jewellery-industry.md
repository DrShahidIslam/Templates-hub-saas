...
**Q: How often should we conduct a full inventory audit?**
A: A full, floor-to-ceiling physical inventory count should be performed at least quarterly. High-risk items (loose diamonds over 1 carat) should be counted monthly.

**Q: What should I do if I find a discrepancy that cannot be resolved?**
A: All unresolved discrepancies must be escalated to the Audit Committee or senior management immediately. If the loss is significant, initiate the Internal Investigation Protocol and consider notifying insurance providers.
