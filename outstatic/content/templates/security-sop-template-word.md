...
**1. How often should security SOPs be reviewed?**
Security SOPs should undergo a formal review annually. However, they must be updated immediately following any significant security incident, personnel change, or upgrade in site technology.

**2. What is the best way to store these documents?**
Security SOPs should be stored in a secure, encrypted digital vault with restricted access rights. Hard copies should only be kept in high-security, authorized locations (e.g., the Security Operations Center).
