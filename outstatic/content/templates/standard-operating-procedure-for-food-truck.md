...
**Q: What should I do if a health inspector arrives unannounced?**
A: Stay calm, be professional, and ask for identification. Provide them with the required logs (temperature and sanitization) immediately and allow them access to the unit. Record their feedback in your daily log.

**Q: How do I handle a generator failure during service?**
A: Immediately turn off high-draw equipment (fryers/AC) to prevent engine overload. If it cannot be restarted, switch to "Emergency Menu" or, if temperatures rise above 41°F, declare a food safety emergency and stop service.
