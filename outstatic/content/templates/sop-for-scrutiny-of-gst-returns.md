...
**Q1: What should I do if I find a discrepancy between my books and GSTR-2B?**
A: Immediately communicate with the vendor to ensure they have uploaded the invoice. If the vendor has missed it, request them to file it in the next period. Do not claim the credit until it appears in your GSTR-2B.

**Q2: Are there any penalties for late filing even if there is no tax liability?**
A: Yes, late filing of returns (even NIL returns) attracts a late fee per day under the GST Act. Always ensure NIL returns are filed on time.
