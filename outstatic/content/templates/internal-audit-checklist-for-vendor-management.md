...
**1. How often should an internal audit of vendor management be conducted?**
High-risk vendors should be reviewed annually. A comprehensive audit of the entire vendor management program, including policy effectiveness, should be performed at least every 12 to 18 months.

**2. What should I do if I find an active vendor without a signed contract?**
Immediately flag this as a "Critical Finding." Cease further payments until a contract is signed, and conduct a retrospective review to ensure the vendor’s services were actually rendered as billed.
