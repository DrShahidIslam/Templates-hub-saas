...
**Q: Can I use tubes from a different manufacturer than the centrifuge brand?**
A: Yes, provided the tubes are chemically compatible with your samples and are rated for the maximum RCF (Relative Centrifugal Force) you intend to reach. Always verify the tube’s pressure rating.

**Q: What should I do if the centrifuge makes a loud banging noise during operation?**
A: Abort the run immediately. The noise indicates a serious imbalance or a failure of the internal mounting. Do not attempt to restart the centrifuge; contact maintenance or the manufacturer for an inspection.
