...
**Q: What should I do if I find a fault during the daily inspection?**
A: Immediately tag the crane as "Out of Service," notify the Site Superintendent, and record the specific fault in the official crane logbook. Do not operate the crane until a certified technician has performed repairs and signed off on the safety clearance.

**Q: How often should I check the wire ropes?**
A: While a visual spot-check is part of the daily routine, a detailed inspection of the wire rope (checking for lubrication and diameter reduction) should be performed weekly or in accordance with the manufacturer's maintenance schedule.
