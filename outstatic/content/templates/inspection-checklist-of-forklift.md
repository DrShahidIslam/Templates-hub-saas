...
**Q: What should I do if I find a defect during my inspection?**
A: Do not operate the forklift. Tag the unit as "Out of Service" to prevent others from using it, remove the key, and immediately inform your supervisor to initiate a maintenance work order.

**Q: How often must these inspections be performed?**
A: If the forklift is used on a round-the-clock basis, the inspection must be performed at the beginning of every shift. If used once a day, the inspection must be performed prior to the start of that shift.
