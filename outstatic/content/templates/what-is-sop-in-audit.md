...
**1. How often should an Audit SOP be updated?**
Audit SOPs should be reviewed at least annually or immediately following a significant change in business process, software infrastructure, or regulatory legislation.

**2. Is an audit SOP the same as an Audit Plan?**
No. An Audit Plan is project-specific (who is doing what, when), whereas an Audit SOP is a process-standard document that dictates *how* the organization conducts audits consistently over time.
