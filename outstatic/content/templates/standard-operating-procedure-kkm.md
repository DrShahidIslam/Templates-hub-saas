...
**Q1: What is the mandatory storage temperature range for non-refrigerated pharmaceutical products?**
A: Standard GDP guidelines typically mandate a controlled room temperature between 15°C and 25°C. Any deviation must be investigated via a formal CAPA (Corrective and Preventive Action) report.

**Q2: How should we handle an unannounced KKM inspector visit?**
A: Always maintain professional transparency. Direct the inspector to the Regulatory Liaison Officer, verify their official identification, provide a dedicated workspace, and ensure all requested documentation is produced promptly without unauthorized alteration.
