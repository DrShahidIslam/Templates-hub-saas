...
**1. How often should I perform a full coolant replacement?**
Typically, every 3 to 6 months depending on machine usage, filtration quality, and the types of materials machined. If you notice a foul odor or excessive tool rust, perform a full system flush immediately.

**2. Is it necessary to power down the machine for all maintenance tasks?**
Daily tasks can usually be performed with the machine "ready," but any maintenance involving the electrical cabinet, hydraulic system, or mechanical disassembly must be performed under strict Lock-Out/Tag-Out (LOTO) procedures.
