...
**Q: How often should I conduct an inventory review?**
A: Ideally, a perpetual inventory check should occur daily for high-turnover items, with a full physical audit conducted at least monthly to ensure system accuracy.

**Q: What should I do if a shipment arrives with damaged items?**
A: Do not accept the items into the system. Document the damage immediately, take photographs, contact the supplier’s customer service department for an RMA (Return Merchandise Authorization), and quarantine the items in a "Returns/Damaged" bin.
