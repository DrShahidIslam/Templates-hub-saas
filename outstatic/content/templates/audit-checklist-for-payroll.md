...
**Q: How far back should a standard payroll audit go?**
A: Typically, a standard internal audit covers the most recent quarter. However, if a discrepancy is found, you should expand the scope to the beginning of the current fiscal year to determine if the error is systemic.

**Q: What is the most critical item to look for during an audit?**
A: The most critical item is the reconciliation between the payroll register and the actual bank disbursement. If these two numbers do not match, there is an immediate risk of fraud or accounting error.
