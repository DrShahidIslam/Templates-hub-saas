...
**1. How do I know if the surface is ready for the second coat?**
Follow the "Recot Time" provided on the paint can's Technical Data Sheet. If the paint feels "tacky" or pulls away when touched lightly, it is not ready for the next layer.

**2. What is "flashing" and how can I prevent it?**
Flashing is the uneven appearance of sheen across a surface. It is usually caused by "dry rolling" or applying paint over an unprimed, porous surface. Ensure the surface is properly primed and maintain a "wet edge" while rolling.
