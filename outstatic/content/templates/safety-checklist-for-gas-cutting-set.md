...
**Q: Can I use Teflon tape to seal leaking gas cutting connections?**
A: No. Never use Teflon tape on gas cutting equipment connections. These connections are typically "metal-to-metal" or "cone-seat" seals. If a connection leaks, the threads or the seat are damaged and must be replaced; adding tape can lead to loose, dangerous connections.

**Q: What should I do if I experience a flashback?**
A: If a flashback occurs (typically heard as a popping sound or a screeching noise), immediately close the oxygen valve on the torch handle, then the fuel gas valve. Close the cylinder valves and do not attempt to reuse the equipment until it has been inspected by a certified technician.
