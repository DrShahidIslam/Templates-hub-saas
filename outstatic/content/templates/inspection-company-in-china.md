...
**Q: What should we do if the factory refuses to allow us to open all selected cartons?**
A: This is a major red flag. Record this as a "Non-Compliance" in your report and immediately notify the client. Never proceed with an inspection if you cannot access the full sample size.

**Q: If the inspection fails, should the inspector tell the factory how to fix it?**
A: No. As an objective third party, our role is to report, not to consult. Providing technical solutions can create a conflict of interest and may inadvertently lead to product liability issues.
