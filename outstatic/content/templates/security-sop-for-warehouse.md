...
**1. How often should we conduct a full facility security audit?**
We recommend a comprehensive physical and digital security audit at least twice a year, supplemented by weekly walkthroughs and monthly systems testing.

**2. What should an employee do if they witness suspicious activity?**
The employee should not engage the individual. They should immediately contact the Security Supervisor, maintain a safe distance, and record as many details as possible (time, physical description, vehicle plates, specific actions) for the Incident Report.
