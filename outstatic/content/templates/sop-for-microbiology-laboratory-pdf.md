...
**Q: What should I do if a spill occurs involving a pathogenic organism?**
A: Immediately cover the spill with paper towels, saturate the area with disinfectant (e.g., 10% bleach), and allow it to sit for 20 minutes. Dispose of the materials as biohazardous waste and notify the Laboratory Manager.

**Q: How often should the lab benches be deep-cleaned?**
A: Bench surfaces should be disinfected before and after every procedure. A comprehensive deep clean (including drawers and equipment housing) should occur on a monthly basis.
