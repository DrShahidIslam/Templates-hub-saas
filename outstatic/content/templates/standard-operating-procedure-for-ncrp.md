...
**1. Who is responsible for opening an NCR?**
Any employee who identifies a deviation from standard operating procedures or quality requirements is responsible for initiating an NCR.

**2. What is the difference between an NCR and a Corrective Action (CAPA)?**
An NCR is the documentation of a specific failure at a specific point in time. A CAPA is a more comprehensive, systemic investigation triggered when an NCR suggests a broader process failure that requires a long-term, multi-departmental solution.
