...
## FAQ
**Q: What should I do if a child arrives with an unexplained injury?**
A: Immediately perform a secondary assessment with another staff member, document the injury in detail, take a photograph if permitted, and require the parent to sign an "Injury Disclosure Form" upon arrival.

**Q: How often must high-touch surfaces be sanitized?**
A: High-touch surfaces (doorknobs, light switches, changing tables, and shared toys) must be sanitized every 2 hours or immediately following a suspected contamination event.
