...
**1. Is it mandatory to perform an in-person Right to Work check in the UK?**
Not necessarily. Since 2022, many checks can be completed via the Home Office online portal using a share code. For manual checks, you must see the original documents in the presence of the employee (either physically or via video call with specific security parameters).

**2. What happens if a new employee does not have a P45?**
If a P45 is unavailable, have the employee complete a HMRC "Starter Checklist." This allows you to assign the correct tax code temporarily until HMRC sends the official coding notice.
