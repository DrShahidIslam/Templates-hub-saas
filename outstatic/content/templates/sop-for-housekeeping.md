...
**1. How do I handle a situation where a guest’s personal belongings are left out?**
Do not touch or organize personal items. Clean around them carefully. If you must move an item to clean a surface, document its original location and return it exactly as found.

**2. What should I do if I find a maintenance issue, like a broken chair?**
Do not attempt to fix it yourself unless you are authorized. Tag the item as "Out of Order," notify your supervisor immediately, and log it in the facility maintenance software.
