...
**1. Is an SOP the same as a Work Instruction?**
No. An SOP is a high-level document that describes the "who, what, and when" of a process. A Work Instruction is a much more granular document that focuses on the specific "how-to" steps of a single, highly technical sub-task.

**2. How often should we update our SOPs?**
You should update your SOPs whenever there is a change in software, equipment, regulatory requirements, or personnel workflows. At a minimum, perform a scheduled audit once a year.
