...
**Q: How often should the accounts department perform a bank reconciliation?**
A: Bank reconciliations should be performed at least weekly to ensure cash flow visibility, with a full, formal reconciliation required during the month-end close.

**Q: What is the procedure if a duplicate invoice is discovered?**
A: Immediately void the duplicate entry in the accounting system, notify the vendor, and ensure the original invoice has been properly stamped or marked as "Paid" to prevent future processing.
