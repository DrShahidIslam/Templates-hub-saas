...
**Q: What should I do if the measurement tools are past their calibration date?**
A: Stop the inspection immediately. Do not use the tool. Notify the Quality Manager so a calibrated replacement can be provided and the out-of-calibration tool can be sent for recertification.

**Q: How do I handle a "borderline" case where the part is technically within tolerance but looks imperfect?**
A: Consult the "Golden Sample" or the Customer Quality Agreement. If ambiguity remains, escalate to the Quality Manager for a formal disposition. Never make a subjective pass/fail call without a clear reference.
