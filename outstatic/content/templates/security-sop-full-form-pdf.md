...
**Q: Why must security SOPs be in PDF format rather than Word?**
A: PDFs are read-only and prevent accidental or malicious alterations to the text. They also maintain consistent formatting across all operating systems and mobile devices.

**Q: How often should we update our security documentation?**
A: Security documentation should be reviewed at least once every 12 months, or immediately following any significant security incident or change in infrastructure.
