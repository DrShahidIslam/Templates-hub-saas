...
**Q: How often should a process be analyzed?**
A: Processes should be reviewed annually or whenever there is a significant change in technology, organizational structure, or a 10% deviation in key performance indicators (KPIs).

**Q: What is the most common form of waste to look for?**
A: Waiting time. In almost every professional environment, the "dead time" between tasks (waiting for approval, waiting for data, waiting for emails) is where the most significant gains can be found.
