...
**Q: What should I do if a plate is accidentally dropped during sampling?**
A: Do not use the plate. Discard it as waste, document the event as a sampling deviation in the logbook, and use a fresh, sterile plate to repeat the sample.

**Q: How do I handle a "Growth" result that exceeds the Action Limit?**
A: Immediately notify the QA/QC Manager. Perform an investigation to identify the root cause, assess the impact on product quality, and implement the necessary CAPA (Corrective and Preventive Action) plan.
