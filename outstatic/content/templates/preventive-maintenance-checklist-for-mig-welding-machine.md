...
**1. How often should I perform this full inspection?**
For machines used in a daily production environment, a full inspection should be conducted monthly. High-intensity shifts may require weekly checks on consumables and wire feed components.

**2. Why is my wire feed stalling even after I tightened the tension?**
Do not over-tighten; this often makes the problem worse by deforming the wire. Check for a clogged liner or a worn-out contact tip first. If the liner is kinked or full of debris, cleaning or replacement is required.
