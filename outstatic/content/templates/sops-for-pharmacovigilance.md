...
**Q: What is "Day 0" in Pharmacovigilance?**
A: Day 0 is the date on which any personnel of the company (including medical representatives or consultants) first receive the minimum four criteria of an adverse event report. This starts the clock for regulatory submission deadlines.

**Q: How should we handle reports received via social media?**
A: If a company manages its own social media pages, it must monitor them for adverse events. Once identified, these reports must be treated with the same urgency as reports via phone or email, documented, and assessed according to this SOP.
