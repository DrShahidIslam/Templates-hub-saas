...
**Q: How often should the restroom be checked if there is no set cleaning time?**
A: High-traffic restrooms should be inspected every 2 hours at minimum, regardless of whether a full deep clean is required.

**Q: What should I do if a biological spill (blood or bodily fluids) is present?**
A: Do not attempt to clean this with standard supplies. Contact your supervisor immediately to request a specialized biohazard cleanup team.
