...
**Q: How often should I perform a full grease lubrication of the bucket pins?**
A: Under standard operating conditions, all boom, arm, and bucket pins should be greased every 8 to 10 hours of operation. If working in water, mud, or extreme dust, increase this frequency to every 4 hours.

**Q: What is the most common cause of hydraulic pump failure?**
A: Contamination. Even microscopic debris can score the internal components of a high-pressure pump. Always wipe off grease zerks and hydraulic fill caps before removing them to prevent dirt from entering the system.
