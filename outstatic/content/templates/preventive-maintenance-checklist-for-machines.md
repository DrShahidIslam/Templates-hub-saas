...
**Q: How often should I update the preventive maintenance schedule?**
A: Review schedules annually or whenever there is a significant change in production load, machine duty cycle, or when OEM recommendations are updated.

**Q: What should I do if a safety guard is missing during an inspection?**
A: You must immediately tag the machine as "Out of Service" and prevent operation until the guard is replaced or a compliant fabrication is installed. Never bypass safety interlocks.
