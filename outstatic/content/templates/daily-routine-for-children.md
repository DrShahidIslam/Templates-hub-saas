...
**Q: What should I do if the child refuses to follow a specific step?**
A: Remain calm and firm. Offer a "choice" (e.g., "Would you like to brush your teeth before or after we put on pajamas?"). This provides the child with a sense of agency while still achieving the objective.

**Q: How do I handle sudden changes to the routine?**
A: Use "pre-announcement" communication. Inform the child of the schedule change as early as possible to minimize anxiety regarding the deviation.
