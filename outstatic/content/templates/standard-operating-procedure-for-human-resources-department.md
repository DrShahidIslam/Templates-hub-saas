...
**Q: How long should employee records be maintained after termination?**
A: Records should generally be kept for at least 7 years, though you must check local labor laws, as some jurisdictions require longer retention periods for specific documents like payroll or medical records.

**Q: What is the recommended frequency for performance check-ins?**
A: While formal reviews are typically annual or semi-annual, we highly recommend monthly or quarterly check-ins to ensure goals remain relevant and to provide timely course correction.
