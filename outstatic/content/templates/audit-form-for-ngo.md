...
**Q: How often should an NGO conduct an internal audit?**
A: It is recommended that NGOs perform a full internal audit at least annually. Smaller, programmatic "spot audits" should be conducted quarterly to catch issues early.

**Q: What if I find a discrepancy during the audit?**
A: Discrepancies should be categorized by severity (Low, Medium, High). Document the issue, discuss it with the program lead for context, and require a formal "Corrective Action Plan" (CAP) with a firm timeline for resolution.
