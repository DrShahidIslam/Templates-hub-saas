...
**Q: How often should we audit our current vendor list?**
A: Ideally, conduct a "Vendor Rationalization" audit annually. This helps eliminate redundant vendors and identify opportunities to consolidate services for better volume pricing.

**Q: What should I do if a vendor fails to meet a critical SLA?**
A: Document the breach immediately. Depending on the severity, issue a "Notice to Cure" as defined in your contract. Do not wait until the end of the quarter to address significant failures.
