...
**Q: What is the mandatory protocol if a patient presents with heavy vaginal bleeding?**
A: Immediate triage is required. Assess hemodynamic stability (BP and pulse), obtain an urgent point-of-care pregnancy test, and prepare for an emergency transvaginal ultrasound or transfer to the nearest labor and delivery/emergency department if the patient is unstable.

**Q: How should a chaperone be handled if one is not immediately available?**
A: You must delay the intimate examination until a chaperone (nurse or medical assistant) is present. Document in the EHR that the exam was delayed until a witness could be secured.
