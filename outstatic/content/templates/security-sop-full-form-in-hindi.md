...
**1. What is the main purpose of an SOP in security?**
The main purpose is to provide a standardized, repeatable process that reduces variations in performance, ensures consistency, and provides a clear guide for responding to emergencies efficiently.

**2. How often should a Security SOP be reviewed?**
A Security SOP should ideally be reviewed every 6 months or immediately following any significant security incident or change in facility layout.
