...
**Q: How often should we conduct an internal quality audit?**
A: Regulatory requirements typically mandate that internal audits be performed at planned intervals, usually at least annually. However, high-risk processes or significant QMS changes may necessitate more frequent, focused audits.

**Q: What is the biggest red flag during an audit?**
A: A lack of connection between a CAPA and its root cause. If the facility identifies a problem but repeatedly "fixes" it with retraining instead of addressing a design or process flaw, it indicates a weak or superficial QMS.
