...
**Q: Do I need to provide proof of a negative test to return to work?**
A: We follow current CDC and local health department guidelines. Depending on the current risk level, we may require proof of a negative test or a doctor’s note verifying that the individual is no longer infectious.

**Q: Are masks mandatory in the workplace?**
A: Mask requirements are subject to change based on local transmission rates. Please check the "Current Safety Level" on the company intranet portal each Monday for the weekly mandate.
