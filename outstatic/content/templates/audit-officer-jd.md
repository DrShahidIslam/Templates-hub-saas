...
**1. What should I do if a department head refuses to provide access to records?**
Immediately escalate the matter to the Internal Audit Manager or the Audit Committee. Ensure the refusal is documented in your working papers as a "limitation of scope."

**2. How do I determine the "Risk Rating" for a finding?**
Risk is determined by a combination of *Likelihood* (how often it could happen) and *Impact* (financial loss, reputational damage, or regulatory penalty). Use your organization's established Risk Matrix to assign these ratings consistently.
