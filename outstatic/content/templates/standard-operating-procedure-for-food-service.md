...
**Q: What is the most critical temperature range to avoid?**
A: The "Danger Zone" is between 41°F and 135°F (5°C – 57°C). Bacteria grow most rapidly in this range; food must move through these temperatures as quickly as possible.

**Q: How should a staff member handle a suspected food allergy incident?**
A: Immediately stop all preparation for that order, involve a manager, and consult the documented allergen ingredient list. Do not rely on memory; verify labels or recipe cards.
