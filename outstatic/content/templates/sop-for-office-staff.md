...
**Q: What should I do if an urgent visitor arrives but the person they are meeting is unavailable?**
A: Politely inform the guest that the host is currently unavailable, offer them a seat and a refreshment, and reach out to the host's direct manager or backup for instructions on how to handle the guest's needs.

**Q: How do I handle a request for supplies that isn't on the approved procurement list?**
A: Direct the request to the Office Manager. Do not purchase unauthorized items using company funds without prior written approval.
