...
**Q: What should I do if the weighbridge display is not returning to zero?**
A: Do not force a manual reset. Check the platform for debris or trapped objects. If the platform is clear and the reading remains off-zero, trigger the "Maintenance Mode" and contact the calibration technician immediately. Do not conduct further weighings.

**Q: How do I handle a weight discrepancy between our weighbridge and the customer’s weighbridge?**
