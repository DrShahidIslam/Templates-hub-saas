...
**Q: What should I do if a team member is absent during the morning briefing?**
A: That individual must receive a formal, one-on-one briefing from a supervisor covering all points from the group session before they are permitted to enter the work area.

**Q: How do I handle a worker who consistently ignores safety protocols discussed in the briefing?**
A: Document the behavior immediately, remove them from the high-risk task, and initiate your company’s disciplinary procedure. Safety is a condition of employment.
