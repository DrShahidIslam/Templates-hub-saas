...
**Q: My torque reading is flashing or displaying "EEEE." What does this mean?**
A: This indicates an over-range error. You are likely using a spindle/speed combination that is too large or too fast for the sample’s actual viscosity. Stop the motor, select a smaller spindle or lower the RPM, and restart.

**Q: How often should the viscometer be calibrated?**
A: Routine calibration verification (using standard viscosity oils) should be performed at least once per month or after any major maintenance. Professional certified calibration should occur annually.
