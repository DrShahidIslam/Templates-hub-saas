...
A: Risk assessments should be formally reviewed at least annually, or immediately following any significant operational change, project milestone, or security incident.

**Q: What is the difference between inherent risk and residual risk?**
A: Inherent risk is the level of risk before any controls are applied. Residual risk is the level of risk that remains after mitigation strategies have been implemented.
