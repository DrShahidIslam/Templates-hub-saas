...
**Q: Can I use a Bunsen burner inside the BSC?**
A: No. Open flames create thermal currents that disrupt the laminar airflow, potentially pulling unfiltered air into the work zone or damaging the HEPA filter. Use an electric incinerator instead.

**Q: Why must I move my arms slowly into the cabinet?**
A: Rapid movement creates "wake turbulence" behind your arms. This turbulence can carry contaminants from the work surface into the "clean" space or out past the front sash, endangering the operator.
