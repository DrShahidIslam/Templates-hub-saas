...
**Q: How frequently should vendor audits be conducted?**
A: Critical vendors should be audited annually. Non-critical or low-risk vendors can be audited every 2–3 years, or whenever there is a significant change in their service delivery model.

**Q: What if a vendor refuses to cooperate with an audit?**
A: Ensure your MSA includes an "Audit Rights" clause. If the vendor refuses, cite the contract, escalate to your legal department, and consider this a "Red Flag" indicating potential non-compliance or hidden risks.
