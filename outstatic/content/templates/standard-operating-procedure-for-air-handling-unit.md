...
**1. How often should filter pressure differentials be checked?**
In high-traffic commercial buildings, filter differential pressure should be checked monthly. In clinical or high-sensitivity environments, this should be done weekly.

**2. What should I do if the AHU motor is running hot to the touch?**
First, check the amperage against the motor nameplate. If it is within range, check the blower assembly for blockages or mechanical resistance. If the amperage is high, the motor may be nearing failure; check for voltage imbalances.
