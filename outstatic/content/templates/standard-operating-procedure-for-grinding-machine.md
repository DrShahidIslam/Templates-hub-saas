...
**1. How often should the grinding wheel be dressed?**
The wheel should be dressed whenever it becomes loaded with metal, loses its cutting edge (glazing), or if the surface becomes uneven or out-of-round. Regular dressing maintains the integrity of the abrasive grains.

**2. What do I do if I find a crack in the grinding wheel?**
Immediately remove the machine from service by locking out/tagging out (LOTO) the power source. Report the defect to the shift supervisor and replace the wheel with a new, certified one before resuming operation. Never attempt to use a cracked wheel.
