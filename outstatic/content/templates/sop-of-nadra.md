...
**Q1: What should be done if the system rejects biometrics repeatedly?**
If fingerprints fail due to medical conditions, utilize the "Biometric Exception" protocol, which requires medical documentation or secondary identification verification by a senior supervisor.

**Q2: Can a representative apply on behalf of the applicant?**
No. Due to the requirement for live biometric verification and facial capture, the physical presence of the applicant is mandatory for all primary identity card applications.
