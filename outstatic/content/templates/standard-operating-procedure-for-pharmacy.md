...
**Q: What should I do if the system flags a "High Alert" interaction?**
A: You must stop the dispensing process, consult the clinical interaction database, and contact the prescribing physician to verify if the dual therapy is intentional. Document the outcome clearly in the patient profile.

**Q: How often should we conduct inventory audits?**
A: Controlled substances must be reconciled daily. General inventory should undergo a cycle count monthly to ensure system quantities match physical stock, preventing out-of-stock scenarios.
