...
## FAQ
**Q: What should I do if the gauge is in the red zone?**
A: Immediately remove the extinguisher from service, tag it as "Out of Service," notify the safety manager, and replace it with a spare unit until a professional can recharge or replace the defective one.

**Q: Do I need a professional technician to perform the monthly inspection?**
A: No, the monthly inspection is a "user-level" visual check that can be performed by designated facility staff. However, the annual maintenance check must be performed by a licensed fire protection professional.
