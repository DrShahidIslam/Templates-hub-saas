...
**Q: How often must an internal audit be performed?**
A: ISO 13485 requires internal audits to be performed at planned intervals. Generally, this is interpreted as a comprehensive audit of the entire QMS at least once per calendar year.

**Q: What is the difference between a minor and major non-conformity?**
A: A minor non-conformity is an isolated incident where a requirement is not met. A major non-conformity represents a systemic breakdown of a process or a significant risk to product safety and regulatory compliance.
