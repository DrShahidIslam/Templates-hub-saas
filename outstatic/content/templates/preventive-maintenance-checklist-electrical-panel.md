...
**1. How often should electrical panels undergo preventive maintenance?**
Typically, critical electrical panels should be inspected annually. However, high-vibration environments or facilities with heavy motor loads may require semi-annual inspections.

**2. Why must I use a HEPA-rated vacuum instead of a standard shop vac?**
Standard shop vacuums are not filtered to prevent the spread of fine conductive dust, which can settle on other sensitive electronic equipment in the area and cause secondary faults.
