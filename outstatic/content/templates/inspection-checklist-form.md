...
**Q: What should I do if the inspection tool is out of calibration?**
A: Stop the inspection immediately. Tag the tool as "Out of Service" and request a replacement from the maintenance department. Never proceed with an inspection using unverified tools.

**Q: How do I handle a non-conformity that is not listed on the standard checklist?**
A: Most digital forms include an "Additional Observations" or "Other" field at the bottom. Document the issue there with as much detail as possible, including photographs.
