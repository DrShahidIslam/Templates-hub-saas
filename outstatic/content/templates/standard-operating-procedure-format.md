...
SOPs should be reviewed at least annually or immediately following any significant change in software, hardware, or company policy.

**2. Should an SOP be written for every task?**
No. SOPs are intended for recurring, high-stakes, or complex tasks where consistency is required for safety, quality control, or efficiency. Avoid documenting low-impact, one-off tasks.
