...
*   **Portal Access:** Log in to the official [OCI Services portal](https://ociservices.gov.in/).
...
**Q: Can I apply for an OCI card if I am currently in India on a tourist visa?**
A: No. OCI applications must generally be filed from your country of current citizenship. You cannot convert a tourist visa to an OCI status while physically present in India.

**Q: Does my spouse automatically get an OCI card if I am an OCI holder?**
A: A foreign-origin spouse is eligible only after two years of marriage to an Indian citizen or OCI holder. The marriage must be registered and subsisting.
