...
A: Typically, it takes about 30 days to hear back, though it can be faster. If it takes longer, it is usually due to a high volume of applications or the need for a more thorough manual review of complex content.

**Q: Can I apply if I have a copyright claim?**
A: Copyright *claims* (which usually result in ad revenue going to the rights holder) are generally acceptable, but *Copyright Strikes* are not. Ensure all active strikes are cleared before applying.
