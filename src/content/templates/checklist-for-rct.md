...
**Q: What should I do if a file separates during the procedure?**
A: Remain calm. Attempt to bypass the file with a small hand file and EDTA. If it cannot be bypassed or removed, document the location, inform the patient, and evaluate if the canal can still be effectively disinfected. If prognosis is compromised, refer to an endodontist.

**Q: How long should a temporary restoration remain in place?**
A: A temporary restoration should ideally be replaced with a definitive crown or composite buildup within 2–4 weeks to prevent fracture of the tooth structure and bacterial leakage.
