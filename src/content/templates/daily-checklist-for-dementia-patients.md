...
**Q: What should I do if the resident becomes aggressive during a hygiene routine?**
A: Stop the task immediately. Aggression is often a sign of fear, pain, or overstimulation. Back away, lower your voice, and try to re-engage once the resident is calm. 

**Q: How do I manage refusal of medications?**
A: Ensure the medication is presented in a way that is easy to swallow (e.g., in applesauce, if approved by a pharmacist). If refusal persists, consult the physician to discuss alternative delivery methods or timing.
