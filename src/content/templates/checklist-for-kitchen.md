...
## FAQ
**Q: How often should we check the temperature of the walk-in cooler?**
A: Temperatures should be checked and logged at least twice per shift (once during opening and once during closing) to ensure the unit stays below 40°F.

**Q: What is the correct way to handle a chemical spill?**
A: Refer immediately to the Safety Data Sheet (SDS) binder located in the office. Evacuate the area if necessary and use the appropriate spill kit materials; never use food towels to clean chemical spills.
