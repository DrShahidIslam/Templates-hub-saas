...
## FAQ
**Q: How do I handle files that I need to access for multiple projects?**
A: Use "Shortcuts" (Windows) or "Aliases" (macOS) to link to the original file, rather than creating multiple copies of the same document.

**Q: Should I keep my desktop completely empty?**
A: While a completely empty desktop is the gold standard for focus, having 3-5 shortcuts to essential tools is acceptable. The goal is to avoid having active documents or "pile-up" folders directly on the desktop.
