...
**Q: What do I do if I find a minor issue that doesn't seem to affect operation?**
A: Do not operate the equipment. Any defect, regardless of how minor it appears, must be reported. Only a qualified maintenance technician should determine if a forklift is safe to operate.

**Q: Can I perform the inspection while the forklift is moving?**
A: No. Initial checks must be done while the unit is stationary and the engine is off to ensure a safe, thorough inspection. Operational checks should be done in a designated, clear, and low-traffic area.
