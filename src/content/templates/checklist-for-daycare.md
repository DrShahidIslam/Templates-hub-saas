...
**Q: What should I do if I notice a toy is broken during the day?**
A: Immediately remove the toy from the environment and place it in a "Repair/Discard" bin. Do not allow children to access the item until it has been professionally repaired or disposed of permanently.

**Q: How do we handle a child who arrives with symptoms of illness?**
A: Follow the facility’s Illness Policy strictly. If the child meets the criteria for exclusion (e.g., fever over 100.4°F, vomiting, or persistent cough), you must refuse entry and instruct the parent to follow the established recovery protocol before returning.

**Q: Who is responsible if the daily checklist is not completed?**
A: The Lead Teacher of each room is responsible for the completion of the checklist. The Assistant Director conducts daily audits of these checklists; failure to document procedures results in a mandatory corrective action review.