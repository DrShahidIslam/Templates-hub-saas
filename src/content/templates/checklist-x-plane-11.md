...
**Q: Why do my gauges flicker or show no power even after turning the battery on?**
A: Ensure your "Avionics Master" switch is toggled ON. In X-Plane 11, many aircraft separate the Battery (DC power) from the Avionics bus (Radio/GPS power).

**Q: How do I calibrate my hardware if the aircraft keeps banking to one side?**
A: Open the X-Plane "Joystick" settings and click "Calibrate." Ensure your yoke or joystick is centered, and check for any hardware "ghosting" inputs in the bottom bar.
