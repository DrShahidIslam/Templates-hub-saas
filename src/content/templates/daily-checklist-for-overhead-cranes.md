...
**Q: What should I do if the emergency stop button does not work?**
A: Immediately remove the crane from service by unplugging the pendant (if applicable) or locking out the main power disconnect. Tag the unit and contact the maintenance department. Do not operate the crane under any circumstances.

**Q: How often must these inspections be documented?**
A: A formal inspection must be documented daily, prior to the start of each shift. If the crane is operated across multiple shifts, each new operator is responsible for their own pre-shift inspection.
