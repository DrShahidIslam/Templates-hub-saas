...
**Q: How do I handle a missed medication dose?**
A: Do not "double up" on doses. Contact the individual’s primary care physician or pharmacist immediately to receive instructions on whether to skip the dose or adjust the timing.

**Q: What should I do if the individual refuses to follow the daily routine?**
A: Avoid confrontation. Attempt to frame the routine as a choice (e.g., "Would you prefer to wash up before or after breakfast?") to provide a sense of autonomy while still achieving the safety goals.
